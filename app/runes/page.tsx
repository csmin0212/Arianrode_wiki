...
const population = [
  { race: "히유린",   pct: 90, color: "#2A5F9E" },
  { race: "엘다나안", pct:  5, color: "#5B4A7A" },
...
function OverviewSection() {
  return (
    <div>
      ...
      <Prose text={"온천이나 샘, 용출 형식의 구분만 해도 80가지를 넘는 수많은 온천을 보유한 '백탕(百湯)'이라 불리는 온천 마을로, 입욕이 주요 산업인 거리.\n\n원래는 에린디르의 히유린들이 목욕 좋아하는 국민인 덕에, 몸을 씻는 것을 게을리하지는 않지만, 온천은 그냥 뜨거운 물이 아니다. 루네스는 원래 경관과 전망을 관광 자원으로 하는 거리였지만, 온천 개발을 시도하면서 20종류 이상의 형식이 다른 온천이 발견되어 온천이 주된 시설이 됐다.\n\n현재는 에린디르 최대의 요양지로 발전하고 있다. 슈펜거 백작 가문이 대대로 이 거리를 다스리고 있으며, 현재의 에벤톤·슈펜거 백작 역시 루네스 발전에 열정을 기울이고 있다."} />
  ...
  return (
    <div style={{ display: "flex", height: "100vh", fontFamily: "'Noto Sans KR', sans-serif", background: "#F7F4EE", color: "#2a2a2a" }}>
      ...
      <nav style={{
        ...
        <div style={{ padding: "12px 20px", borderTop: "1px solid rgba(255,255,255,0.06)", fontSize: "10px", color: "#403050", lineHeight: 1.6 }}>
          <a href="/erlan" style={{ color: "#705880", textDecoration: "none", fontSize: "11px" }}>← 에를랑 왕국으로</a>
