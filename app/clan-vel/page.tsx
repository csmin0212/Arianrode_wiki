...
const clanvelStats = {
  population: "약 2만 명",
  raceComposition: [
    { race: "히유린",   pct: 60, color: "#2A5F9E" },
    { race: "엘다나안", pct: 19, color: "#1A6B4A" },
    { race: "네바프",   pct: 10, color: "#8B6914" },
    { race: "필보르",   pct: 9,  color: "#4A7A2E" },
    { race: "바나",     pct: 2,  color: "#B85C2A" },
...
const clanvelCharacters: Character[] = [
  ...
  },
  {
    ...
    nameKo: "아니에스·바라티에",
    quote: "물의 목소리를 들어보세요",
    race: "엘다나안", gender: "여", age: "30",
    hairColor: "금", eyeColor: "파란", skinColor: "흰",
    title: "클란=베르 신전 사제",
    content: "클란=베르 대신전에서 정령 신앙 의식을 담당하는 엘다나안 사제. 수계 정령과의 교신에 뛰어난 재능을 가지고 있으며, 신관장 웰치의 최측근이기도 하다. 도시의 운하를 관리하는 수계 정령들과 정기적인 의식을 통해 소통하며, 수문 조작이나 홍수 예방에도 기여하고 있다.",
  },
  {
    name: "ディガム・マクギガン",
    nameKo: "디감·막기간",
  ...
  return (
    <div style={{ display: "flex", height: "100vh", fontFamily: "'Noto Sans KR', sans-serif", background: "#F7F4EE", color: "#2a2a2a" }}>
      ...
      <nav style={{
        ...
        <div style={{ padding: "12px 20px", borderTop: "1px solid rgba(255,255,255,0.06)", fontSize: "10px", color: "#203848", lineHeight: 1.6 }}>
          <a href="/gran-felden" style={{ color: "#305870", textDecoration: "none", fontSize: "11px" }}>← 파리스 동맹으로</a>
