...
function HistorySection() {
  return (
    <section>
      ...
      <Prose text="알베르트·테니아와 모험가들은 공중 정원 조사에 착수했다. 성력 1006년, 에린딜 각지에서 하늘을 날아다니는 새들의 목격 사례가 이어지고, 그 무렵 대규모 마법 기관이 차단되면서 전송기와 테니아를 연결하는 마법진이 끊겼다. 신전의 신관 루프트 도벨은 상부에 이 이상 징후를 보고했지만, 결국 상황은 최악으로 치달아 테니아는 마계로 추락했다." />
      ...
      <div style={{ background: "#200818", border: "1px solid #8A1A3A", borderRadius: 8, padding: 14, marginBottom: 16 }}>
        ...
        <p style={{ color: "#CFC4E0", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
          ...
          에린딜의 하늘을 구름으로 뒤덮으려 했지만 모험가들이 저지했고, 그의 죽음과 함께 테니아는 마계로 추락했다.
        </p>
      </div>
