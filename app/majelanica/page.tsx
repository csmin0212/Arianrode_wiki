...
const navItems = [
  { id: "overview",  label: "마제라니카 개요", icon: "🌴" },
  { id: "history",   label: "역사와 영웅",     icon: "📜" },
  { id: "kingdom",   label: "마제라니카 왕국", icon: "👑" },
...
function OverviewSection() {
  return (
    <div>
      <Prose text={"마제라니카 대륙은 에린딜 대륙의 훨씬 남쪽에 있는 대지다. 대자연이 넓어지고, 많은 마수들이 활보하는 야생의 세계이며, 아직 보이지 않는 자원의 보고라고도 여겨지고 있다."} />
      <SecTitle title="개요" />
      <Prose text={"마제라니카 대륙은, 에린딜 대륙의 남방에 존재하는 대륙이다. 오래전부터 에린딜 서방에 그 이름이 알려져 왔으나, 조류와 바람의 관계로 인해 왕래하기 어렵고, 실태는 좀처럼 전해지지 않았다. 현재는 에린딜 서방에서의 항로도 개척되어, 남방 양 대륙의 교류도 서서히 늘어나고 있다."} />
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginTop: 8, marginBottom: 20 }}>
        <div style={{ background: "#fff", border: "1px solid #E8E3DA", borderRadius: 10, padding: "14px 16px" }}>
          ...
          <div style={{ fontSize: "13px", lineHeight: 1.8, color: "#555" }}>마제라니카는 대단히 큰 대륙으로, 그 크기는 에린딜 서방이라 불리는 영역 전역이 대륙 중에 3분의 1은 들어갈 것이라고 일컬어진다. 광대한 마제라니카에는 다양한 기후가 분포하고 있어, 북부의 해안가는 뜨거운 열대에서 아열대에 이르며, 내륙 고지대나 습지대와 사막을 포함한 대륙 중앙부에는 고산 지대가 펼쳐진다. 대륙의 남부 끝은 다시 비교적 험준한 고산 지대가 되며, 화산이 활발하게 활동하고 있다.</div>
        </div>
        <div style={{ background: "#fff", border: "1px solid #E8E3DA", borderRadius: 10, padding: "14px 16px" }}>
          <div style={{ fontFamily: "'Noto Serif KR', serif", fontSize: "13px", fontWeight: 700, marginBottom: 8, color: "#2a2a2a" }}>마제라니카의 주민</div>
          <div style={{ fontSize: "13px", lineHeight: 1.8, color: "#555" }}>현재 마제라니카에 사는 인간들은, 예전에 에린딜에 있던 인간의 자손이라고 여겨진다. 에린딜 서방에서 동방을 향한 해상 여행을 하려는 인간 중에서, 바다에 표류하여 우연히 마제라니카에 도착한 인간들이 있었던 것이 아닌가 추측된다. 마제라니카인이 말하는 언어는 지금도 꽤 많은 부분이 에린딜 서방의 언어에 통하고 있다. 칠대신 신앙도 전해지고 있어, 그 신앙에는 남방 대륙에 독자적으로 전해지는 영웅 신화가 있고, 그 영웅신을 신봉하는 것이 주류다.</div>
        </div>
      </div>
      <SecTitle title="대륙 독자의 직종" />
      <Prose text={"마제라니카의 도시나 집락은, 어디에나 야생 마수의 위협에 처해져 있다. 그 때문에 마수 사냥—마수 사냥을 생업으로 삼는 자들이 존재한다. 이 땅에서 특기인 마수 헌터는 독특한 전투 기술을 발달시키고 있다. 또한 형태를 바꾸는 특수한 단금술을 쓰는 자들은 가드나라 불린다. 마제라니카의 모험자 중에서는 일반적인 직종으로, 대륙의 각지에 그들의 모습이 보인다."} />
      <SecTitle title="다른 나라와의 관계" />
      <Prose text={"마제라니카 대륙은 알디온 대륙이나 노르탄디 대륙과의 사이에는 「대해의 균열」이라는 장애가 있어, 두 대륙 간의 교류는 거의 없다. 그러나 비교적 가까운 에린딜 대륙 동방과의 교류는, 왕성하지는 않지만 행해지고 있다. 해상 교역이 발달한 다이와 군도와 에린딜 동방의 남부에 위치하는 메나아므마이 왕국은, 마제라니카 대륙과의 거리가 비교적 가깝기 때문에 교역도 늘어나고 있다. 또한, 대륙의 북동부 해역에는 인어와 친밀한 어민 사하긴이 사는 캇카루도 교역이 행해지고 있다."} />
    </div>
  );
}
...
function HistorySection() {
  return (
    <div>
      <SecTitle title="마제라니카의 역사" />
      <Prose text={"마제라니카의 휴린 역사는 오래되어, 성력으로 말하자면 100년대에까지 거슬러 올라간다."} />
      <SecTitle title="「불의 시대」 이전" />
      <Prose text={"마제라니카 대륙은, 신이 6종류의 동물을 위해 마련한 땅이라고 일컬어진다. 「불의 시대」 이전에 인간에 대해서는 알려져 있지 않다. 하지만 유적이 소수나마 발견되고 있어, 「불의 시대」 이전의 종족들도, 어떤 형태로든 이 대륙을 발견하고 있었던 것으로 추측된다."} />
      <SecTitle title="「불의 시대」의 시작" />
      <Prose text={"휴린을 중심으로 한 「불의 시대」의 「신의 자녀」가 마제라니카 대륙에 닿은 것은, 성력 128년경이라 추측된다. 예년에 에린을 향한 탐험대가 마제라니카에 표류하는 일이 이어졌으며, 이 탐험대가 마제라니카에 집락을 만든 것으로 여겨진다. 그들은 마제라니카 대륙의 북방 북쪽 해안에 자리를 잡아, 이곳에 거주했다."} />
      <SecTitle title="영웅 나레슈의 탄생" />
      <Prose text={"마제라니카 대륙에 최초로 출현한 인간 영웅은 나레슈라는 이름의 휴린이다. 성력 180년경의 생이라 추측된다. 나레슈는 14세의 당시 인간들의 거처를 위협하고 있었던 밀림의 마수를 벌하고, 마수들의 왕인 「마룡」 브리트라의 복수를 사고 말았다. 나레슈는 「마룡」의 복수를 받아, 대해에 수몰됐다. 그러나 그 곳에서 「바다의 아리아르」에 도움을 받아, 요정의 나라에 도달하게 된다."} />
      <Prose text={"나레슈는 요정들의 나라에서 불사의 과실을 입에 넣어 목숨을 불어넣었다. 이 때 먹은 과실의 영향으로, 나레슈는 육체적으로 늙지 않는 특성을 얻게 됐다. 마제라니카에 돌아온 나레슈는, 「마룡」 브리트라를 격퇴하고 대륙 중앙부의 메루 산에 자리를 잡아, 一大를 지배하게 됐다. 그 후 10년 남짓한 세월을 거쳐, 미지의 땅을 모험하고, 이윽고 「마룡」을 쓰러뜨린다. 그리고 그 공적을 신들에게 인정받아, 나레슈는 신계에 오르고, 신이 됐다고 일컬어진다."} />
      <SecTitle title="6인의 용사" />
      <Prose text={"나레슈가 자리를 잡은 뒤, 인간을 이끈 것은 나레슈와 고생을 함께한 6인의 용사라 한다. 6인의 용사란 에르다나오의 여성 교사「눈의」 니도라, 네바프의 성자「성자」 마우네야, 필볼의 시인「박식한」 나키라르, 바르나 족「신의 딸」 사비야사르치, 도앙 족의 전사「한쪽 날개의」 드로나 등의 자손이라 한다. 그 후도 마제라니카를 모험했다고 한다."} />
      <Prose text={"세대가 정해지고, 마제라니카 왕국이 세워진 것이 마제라니카 력으로 원년(1年)이라 한다. 6개의 번을 모두 거느리는 대번왕에 나레슈의 자손이 임명되고, 마제라니카 력으로 278년의 일이라고 한다."} />
      <SecTitle title="신이 된 나레슈" />
      <Prose text={"브리트라를 물리친 나레슈는, 밀림 지대를 답파하고 마제라니카의 내부를 계속 개척했다. 대륙 중앙부에 있는 메루 산에 한발을 들여놓은 나레슈는, 거기에서 거대한 신 아르케라브를 만나게 된다. 그리고 마제라니카의 인간들을 번영으로 이끌어 달라는 가르침을 받아, 신의 일원이 될 것을 허락됐다. 나레슈는 천계에 오르고, 신이 됐다. 나레슈가 탄생하고 60년 경과했다고 전해진다. 천계에 올라간 나레슈는, 이후 인간들로부터 누구나 숭배받게 됐다. 현재 마제라니카 대륙에서는, 칠대신 신앙 이외에도 「상약왕」 나레슈를 신봉하는 신앙이 깊다."} />
    </div>
  );
}
...
function KingdomSection() {
  ...
  return (
    <div>
      <SecTitle title="마제라니카 왕국" />
      <Prose text={"현재 마제라니카 왕국은 대륙의 거의 전역에 걸쳐 넓은 영역을 6개로 나눠 각 번왕이 지배하고 있다. 6개 지방에는 각각 크고 작은 도시가 있어, 지방을 통치하는 번왕이 그곳에 있다."} />
      ...
      <div style={{ background: `${ACCENT}10`, border: `1px solid ${ACCENT}30`, borderRadius: 10, padding: "14px 18px", marginBottom: 16 }}>
        ...
        <div style={{ fontSize: "13px", lineHeight: 1.8, color: "#555" }}>대번왕이 거처하는 수도는, 예전에 대륙 북방에 있었으나, 마제라니카 력으로 100년쯤 전에 천재에 의해 침수되어 버렸다. 현재는 라사 지방의 도시 카이라샤가 새로운 수도가 되고 있다.</div>
      </div>
      ...
      <Prose text={"인간이 왕이 되어 대륙에 뻗어 나가도록, 마수들도 하나의 몸에 하나의 대륙에 뻗어 나가는 능력을 갖고 있다는 사실로 같다. 마수의 왕들은, 브리트라가 힘을 잃어버린 이후로 스스로를 위해 각각의 영역을 지배하며, 인간들의 진격을 막아내고 있다. 왕에게는 나름의 우두머리가 있으며, 그 능력은 인간의 왕 이상이라 말해진다. 현재, 마제라니카 대륙에서는 왕과 인간 사이의 커다란 싸움이 더욱 넓어지고 있다고 한다."} />
    </div>
  );
}
...
function RegionsSection() {
  const regions = [
    {
      ...
      jp: "海洋地域",
      color: "#2A5A8A",
      content: "마제라니카 대륙 주변의 해양에는 아난타라 불리는 커다란 뱀의 마수가 살고 있다. 아난타에 닮은 대형 생물이 상륙하거나, 연안에 있는 사무드라 지방의 도시를 습격하는 일이 있다.",
    },
    {
      name: "밀림 지역의 마수",
      jp: "密林地域",
    ...
    },
    {
      ...
      jp: "沼地地域",
      color: "#3A5A3A",
      content: "마제라니카 서부 아디 지방의 카차라트 습지에는, 연기의 왕 요요우이트라 불리는 괴물의 무리가 집. 이 생물은 곤충도 파충류도 구별되지 않는 불가사의한 존재이다.",
    },
    {
      name: "화산 지역의 마수",
      jp: "火山地域",
  ...
  return (
    <div>
      <SecTitle title="마제라니카의 8개 영역" />
      <Prose text={"마제라니카 대륙은 크게 8개의 영역으로 나눌 수 있다. 대륙을 에워싸는 대양과 그 경계가 되는 해안선, 빽빽한 밀림, 광대한 평원, 험준한 고산 지대, 다양한 기후를 담은 늪지 지대, 혹독한 환경과 주변에 생식하는 마수들에게 제압 당하여, 아직도 대규모 인간의 집락이 없는 지역이다. 그리고 그것들에 더해, 대륙의 광대한 지하가 퍼져 있는 것이 라사 지방의 어딘가에 그 입구 중 하나로 여겨지는 것이 있으나, 거의 아무에게도 숨겨진 지역이다."} />
...
function EventsSection() {
  return (
    <div>
      <SecTitle title="마제라니카에 전해지는 사건과 전승" />
      <Prose text={"마제라니카 대륙에 전해지는 사건과 전승에는, 이하의 것들이 있다."} />
      <SecTitle title="신이 된 나레슈" />
      <div style={{ background: "#fff", border: "1px solid #E8E3DA", borderRadius: 10, padding: "16px 18px", marginBottom: 16, borderLeft: `4px solid ${ACCENT}` }}>
        ...
        <div style={{ fontSize: "13px", lineHeight: 1.8, color: "#555" }}>브리트라를 물리친 나레슈는, 밀림 지대를 답파하고 마제라니카의 내부를 계속 개척했다. 대륙 중앙부에 있는 메루 산에 발을 들여놓자, 거대한 신 아르케라브를 만나게 됐다. 마제라니카의 인간들을 번영으로 이끌어 달라는 가르침을 받아, 신의 일원이 될 것을 허락됐다. 이 영웅은 현재 「상약왕」이라는 이름으로 마제라니카에서 가장 깊이 신앙받고 있다.</div>
      </div>
      ...
      <div style={{ background: "#1A0808", border: "1px solid #5A1A1A", borderRadius: 10, padding: "16px 18px", marginBottom: 16 }}>
        ...
        <div style={{ fontSize: "13px", lineHeight: 1.8, color: "#CCC" }}>수 년 전부터, 마제라니카 대륙의 곳곳에서 마을과 촌락에서 불길한 소문이 떠돌기 시작하고 있다. 새벽달이 지면, 집을 뒤흔드는 것 같은 낮은 唸り 소리가 어딘가에서 들리는 것이다. 그 날 밤에는 반드시 소수의 인간이 행방불명이 된다고 한다. 이 소문이 퍼지게 된 후로, 각 지역에서 마수들의 움직임이 활성화되고 있어, 예언자를 자처하는 자들 중에는, 나레슈에게 쓰러뜨린 「마룡」 브리트라가 부활할 조짐이라 말하는 자도 있다. 대번왕은 일단 침묵을 지키고 있는 선언을 내놓았으나, 이 뒤에서 몇몇인가의 모험자를 조사에 보내고 있다고 전해진다. 과연 진실은 어떻게 되고 있는 것인가…….</div>
      </div>
    </div>
  );
}
...
function VarunaSection() {
  ...
  const orgs = [
    { name: "마제라니카 해군", type: "군사 조직", base: "판차 항구구·마제라니카 해군 본부", leader: "라-4세", content: "마제라니카의 민과 해역을 마수로부터 지키는 국가 방위군의 해군. 해양과 해안선의 안전을 지키는 활동을 하고 있다. 대표자는 바루나 番王 라-4세이며, 현재는 45대 번왕의 라-4세가 이름 상으로는 톱 자리에 있다." },
    ...
    { name: "마제라니카 무장여단", type: "무역 연합", base: "트리니 항구구", leader: "수잔·누레", content: "마제라니카 대륙 도시를 오가는 행상인들의 통상 동맹. 위험한 도중을 해파하여 도시 사이를 이동하기 위해 정보 수집과 경비 조달을 하고 있다. 또한 신들과 협력하여, 보호 영역 전체에서 무기 조달 의뢰를 보내는 업무를 행하고 있다." },
  ...
  return (
    <div>
      ...
      <Prose text={"마제라니카 대륙의 북방 북쪽 해안에 위치하는 항구 도시. 마제라니카에 휴린이 처음 도착했다고 여겨지는 대륙 북방의 해안 도시이며, 대륙에서도 손에 꼽히는 번영을 이루고 있다."} />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 12, marginTop: 8, marginBottom: 20 }}>
        {[
          ...
          { name: "바루나 신전", desc: "바루나의 종교부문이자 모험자 관리를 담당하는 국가 신전. 판차 항구구의 궁전 가까이에 있다. 지하를 파서 올린 인공 수로가 있으며, 수신의 이름을 내건 마제라니카에 있는 신전 중에서도 유수의 아름다운 신전이다." },
          ...
          { name: "바루나 연금술 학교", desc: "가드나라 불리는 마제라니카 대륙 특유의 연금술사를 양성하는 국가 학교. 번왕 라-4세의 목소리에 의해 샤트 항구구에 건설됐다. 역사는 수십 년이지만, 각지에서 가드나와 연금술 스킬 강사가 초청되어, 수준 높은 교육을 하는 것을 목표로 하고 있다." },
        ].map((f, i) => (
          <div key={i} style={{ background: "#fff", border: "1px solid #E8E3DA", borderRadius: 10, padding: "14px 16px" }}>
...
function KailashaSection() {
  const orgs = [
    { name: "카이라샤 궁정", type: "정부 조직", base: "비슈라파스 구역", leader: "바-7세", content: "마제라니카를 다스리는 대번왕의 거처로서, 국가 중요 사항을 결정한다. 현재는 45대 대번왕인 바-7세가 다스리고 있으며, 역대 왕에게 봉사한 가신들이 많다. 그 수는 수십 명에 이른다고 일컬어지며, 궁전의 넓이는 구역의 대부분을 차지한다." },
    { name: "마제라니카 국방군", type: "군사 조직", base: "비슈라파스 구역·국방군 주둔 기지", leader: "아비지타·테이르발발", content: "마제라니카의 민과 마을을 마수의 위협으로부터 지키는 국방군. 도시나 마을의 방위, 그리고 마수 연구나 무기 연구 등도 행해진다. 마제라니카 군의 임무는 마수 부여가 되는 것과 경우에 따라 위험에 처했을 때만 동원된다." },
  ...
  return (
    <div>
      ...
      <Prose text={"성산이라 불리는 메루 산의 기슭에 존재하는 마제라니카 왕국의 수도에 해당하는 대도시. 「수도」로서의 역사는 그다지 깊지 않지만, 그 자체의 역사적 기원은 대륙 최고의 역사를 가진다."} />
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: 10, marginTop: 8, marginBottom: 20 }}>
        {[
          { label: "인구", value: "5만인" },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 12, marginTop: 8, marginBottom: 20 }}>
        {[
          { name: "마수 연구소", desc: "마제라니카의 인간들에게 천적인 마수를 연구하는 국가 기관. 비슈라파스 구역의 대형 궁전 근처에 있으며, 대대로 마드바 박사의 가문이 운영하고 있다. 연구소의 중요한 임무는 마제라니카의 각지에 탐험대를 파견하여, 마수의 생태를 조사하는 것이다." },
          ...
          { name: "대나레슈 신전", desc: "카이라샤의 구 시가지, 도리타라슈트람 구역 중앙에 건설된 신전이다. 계산으로 240년 전의 역사를 가지는 마제라니카의 성지이며, 나레슈를 신앙하는 총본사. 신전 안은 대부분이 공개된 예배장이 됐으며, 관광지로서도 알려져 있다. 내부에 있는 한쪽 벽면에는 영웅 나레슈의 신화를 그린 벽화가 그려져 있다." },
        ].map((f, i) => (
          <div key={i} style={{ background: "#fff", border: "1px solid #E8E3DA", borderRadius: 10, padding: "14px 16px" }}>
            <div style={{ fontFamily: "'Noto Serif KR', serif", fontSize: "13px", fontWeight: 700, color: "#2a2a2a", marginBottom: 6 }}>{f.name}</div>
            <div style={{ fontSize: "12px", lineHeight: 1.7, color: "#666" }}>{f.desc}</div>
  ...
  const varuna = [
    {
      ...
      skin: "갈색",
      quote: "\"오오, 모험자냐! 잘 왔다!\"",
      note: "마제라니카 왕국의 바루나를 다스리는 番王. 왕위에 오르기 전에는 스스로도 탐험가로서 대륙 탐험을 하고 있었다. 마수를 불러들이는 큰 사건이 있을 때는 스스로 병사들을 이끌고 나아갔다. 대번왕이 되어서부터는 민과 싸운다는 표현 자체를 하지 않아, 그 자신은 '난 알고 있다'는 것을 보이며 상당히 영리한 인물로 알려진다. 도시를 위해 모험자를 보호하고 있어, 모험자에게는 배짱 있게 배려를 보여주는 것으로 알려진다.",
    },
    {
      name: "달샤나·디-파-",
      nameJp: "ダルシャナ・ディーパー",
  ...
  const kailasha = [
    {
      ...
      note: "마제라니카 왕국을 다스리는 대번왕. 뛰어난 영웅 나레슈의 혈통이라 여겨지고 있다. 초기에는 전사로서도 뛰어나지 않고, 영웅이라 불리기에는 아무래도 뒤처지는 자신을 알면서도, 갑자기 영리한 인물로 알려져 있다. 도시를 위해 모험자를 보호하기 위해 모험자를 후원하고 있다.",
    },
    {
      name: "자가드·카루나타카",
      nameJp: "ジャガド・カルナータカ",
    ...
    },
    {
      ...
      note: "대륙에서 이름을 날린 위대한 탐험가 마제라니카·조-의 손자. 후계자로서, 행하는 도중에 어려운 사정에 처하게 되기도 하지만, 꿈과 로맨스를 향해 돌진하고, 선대 마제라니카·조-가 기록한 탐험 일지에는, 대륙 각지의 미지 통로 탐험에 관한 정보가 있으며, 그 정보를 찾는 탐험자들도 많다. 그 정보를 발견한 탐험자에게는 그 정보가 전해진다고 한다.",
    },
    {
      name: "니베-사·마드바",
      nameJp: "ニヴェーサ・マドヴァ",
    ...
    <div style={{ display: "flex", height: "100vh", fontFamily: "'Noto Sans KR', sans-serif", background: "#F7F4EE", color: "#2a2a2a" }}>
      ...
      {(!mob || showNav) && (
        <nav style={{ width: mob ? "100vw" : 220, flexShrink: 0, background: SIDEBAR_BG, display: "flex", flexDirection: "column", padding: "24px 0", overflowY: "auto", position: mob ? "fixed" : "relative", top: 0, left: 0, height: "100vh", zIndex: 999, boxShadow: mob ? "2px 0 16px rgba(0,0,0,0.3)" : "none" }}>
          <a href="/" style={{ display: "block", padding: "0 20px 20px", textDecoration: "none" }}>
            ...
            <div style={{ fontSize: "15px", fontWeight: 700, color: "#fff", fontFamily: "'Noto Serif KR', serif" }}>마제라니카</div>
      ...
      <main ref={mainRef} style={{ flex: 1, overflowY: "auto", padding: mob ? "60px 16px 40px" : "40px 48px", maxWidth: 860 }}>
        <div style={{ marginBottom: 28 }}>
          ...
          <h1 style={{ fontFamily: "'Noto Serif KR', serif", fontSize: mob ? "22px" : "26px", fontWeight: 700, color: "#1a1a1a", margin: 0, lineHeight: 1.3 }}>마제라니카</h1>
