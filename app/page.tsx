...
const timeline: TimelineEvent[] = [
  ...
  { year: "1004년",  events: [
    ...
    '에를랑 왕국 국왕 여왕 에안나 암살 미수 사건',
    '에를랑 왕국 국왕 에루트 13세 암살 미수 사건',
  ...
  { year: "1010년",  events: [
    '에를랑 왕국 왕도 프로글레스에서 "전설의 스파이" 프렛차가 격퇴됐다는 소문',
    '디아스론드 신전이 "오카마" 대학의 설립을 선언',
  ]},
  { year: "1012년",  events: [
    '"대학 도시" 오카마, 대량의 마족들에게 침략당함',
    '에를랑 왕국 왕도 프로글레스에서 마족 그시온에 의한 크리처 저지됨',
    '별의 알이 출현, 토벌됨',
  ]},
];
