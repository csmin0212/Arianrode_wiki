...
const eras: Era[] = [
  {
    name: "빛의 시대",
    content: `최초에 하늘과 땅이 뒤섞여 혼돈만이 있었다. 그후 하늘과 땅이 나뉘고, 그 틈새에서 빛이 생겨났다.\n\n이 하늘과 땅 사이에서 천공신 다그데모라와 대지의 여신 다난이 태어났다. 이 두 기둥은 신들 중에서도 강한 의지를 가진 정령을 "왕"이라 불렀다. 그 다음으로 정령들 중에서도 "빛의 왕" 마라이카가 항상 세계를 청명하게 지속했다. 이후 이어지는 다른 시대보다 뛰어났던 시대였다.`,
  },
  {
    name: "바람의 시대",
  ...
  {
    name: "물의 시대",
    content: `쫓겨나지 않은 악한 자들이 대지의 구멍에 숨어 반격의 기회를 노리고 있었다. 이 마물을 없애기 위해 천공신 다그데모라가 바나를 창조하고, 뇌신 그란아인이 두앙을 만들었다.\n\n하지만 보통의 민이 다시 내분에 빠졌다. 신들은 물의 정령왕 마리드에게 명하여 물로 세계를 정화시켰다. 이것이 "물의 서청"이었다.`,
  },
  {
    name: "땅의 시대",
    content: `새롭게 변한 세계에서, 샘의 여신 아에마가 필보르를 낳고, 대장신 고바논이 네바프를 낳았다.\n\n"물의 서청"에서 유일하게 살아남은 에르다 바랄이 있었다. 그는 마왕이 되어 마족들을 부하로 두고 여러 종족을 지배했다. 도앙 여성들의 기도가 신에게 닿아, 신들은 대지의 정령왕 다오에게 명하여 지옥을 갈라 바랄과 마족들을 마계로 던져넣었다. 이것을 "땅의 서청"이라 불렀다.`,
  },
  {
    name: "불의 시대",
    note: "현재",
    content: `마물이 사라지고 세계는 빛을 되찾았다. 그러나 쫓겨났던 자들이 완전히 사라지지 않았고, 불안에 휩싸여 신들에게 제재를 받았다고 의심하는 자도 적지 않았다.\n\n그러한 시대에, 예언의 여신 브리간티아가 태양신 아케나라브에 의해 보내어진 히유린을 탄생시켰다. 두 민은 다가오는 마물 부활을 막기 위해 보내어졌다는 전설이 있다.\n\n이렇게 "불의 시대"가 시작되었다.`,
  },
];

const godsInfo = `에린에는 7대 신 외에도 많은 신들이 존재하며, 각자 직능을 맡아 역할을 다하고 있다. 주요 7대 신으로는 천공신 다그데모라, 태양신 아케나라브, 예언의 여신 브리간티아, 샘의 여신 아에마, 대장신 고바논, 뇌신 그란아인 등이 있다.\n\n또한 세계의 이치를 다스리는 정령들의 왕과, 에린의 동물들의 시조가 된 7기둥의 동물의 왕들도 각자 역할을 담당하고 있다.\n\n바람의 시대에 에르다들은 세계 창조에 사용된 혼돈의 잔재를 바탕으로 새로운 신을 창조했다. 그러나 에르다들이 창조한 것들은 모두 파괴하려 했다. 이렇게 해서 사신(邪神)들이 탄생했다. 신과의 전투에서 패배한 많은 사신들은 현재 마계나 다른 장소에 봉인되어 있다.`;
...
const regions: RegionItem[] = [
  {
    name: "에린디르 대륙 서방",
    href: "/erindil-west",
    content: `약 800만 평방킬로미터의 광대한 지역. 서방 남쪽은 빙원, 북동쪽은 사막이 넓게 분포한다. 신들에 의해 여러 차례 큰 변혁을 받았기 때문에, 파상의 기복을 가진 광대한 저지가 중앙 부근에 펼쳐진다.\n\n목초 성장이 빠르며 소·말·염소 등의 목축이 왕성하다. 주요 농작물은 밀, 호밀, 귀리, 오트밀, 감자 등이다.\n\n문명은 지구의 15~16세기 유럽에 가까우며, 마법이 당연하게 사용되고 황야에는 위험한 몬스터가 존재한다. 대륙 각지에 신화·전설 시대의 유적이 남아 있으며, 유적의 유물과 네바프의 연금술 덕분에 일부 기술 레벨은 18세기 수준에 달한다.\n\n현재는 신성 반즈탄 제국, 에루란 왕국, 파리스 동맹, 키르디아 공화국의 4국 세력이 크다.`,
  },
  {
    name: "에린디르 대륙 동방",
    content: `에린디르 서방의 동쪽, "무한의 사막"을 넘어 도달하는 땅. 진보한 문명과 광대한 영토를 가진 세세리아 태국, 유목민들의 나라 탈탈·한 제국, 동방 극동의 섬나라 다이와 군도의 3국이 알려져 있다.`,
  },
  {
    name: "알디온 대륙 동방",
    content: `에린디르 대륙 서방에서 넓은 바다를 넘어 도달하는 알디온 대륙의 동방 지역. 대소 다양한 국가들이 탈탈·한 제국과 패권을 다투는 지역이다. 최근 피니아 왕국의 왕녀 비아니 루티나베르·피니아니아가 대륙 통일을 이루었다고 한다.\n\n에린디르 대륙과 알디온 대륙 사이에는 "바다의 거북"이라 불리는 균열이 있으며, 특정 시기에만 건널 수 있다.`,
  },
  {
    name: "아스란",
  ...
  {
    name: "마제라니카 대륙",
    content: `에린디르 대륙 동방 세계의 남방에 있는 대륙. 자연이 풍요로운 대지에서 다양한 동물, 마수, 영수가 서식하고 있다.`,
  },
];

const otherRegions = [
  { name: '"해저 도시" 캇칸루',    content: '에린디르와 마제라니카 사이의 해저에, 샤히긴이 사는 해저 도시가 있다.' },
  { name: '"원환의 거리" 티르밀리', content: '탈탈·한 제국의 황야를 훨씬 넘어 북쪽에 있다고 전해지는 도시. 요정들이 사는 환상적인 도시가 있다고 전해진다.' },
  { name: '"낙원 정원" 테니아',    content: '공중에 떠 있던 아름다운 정원이었지만 마계에 추락했다. 추락의 이유는 불명이다.' },
  { name: '"영원의 거리" 아바론',  content: '유계에 있는 거리의 하나로, "신의 부름을 받은 자"들이 살며 이방자를 맞이하고 있다.' },
  { name: '노탄디 대륙',           content: '에린디르 대륙의 남방에 있는 대륙이지만, 이름 이외에는 알려지지 않았다.' },
];
...
const countries: CountryItem[] = [
  {
    ...
    color: "#2A5F9E",
    accent: "#D4E4F7",
    content: `에린디르 서방에서 가장 오래된 역사를 자랑하는 왕국. 성력 300년경에 건국된 것으로 알려져 있으며, 오랫동안 에린디르 서방의 정치적 중심 역할을 담당해 왔다.\n\n성력 1002년 파리스 동맹 성립 이후 4대국의 세력 균형이 유지되고 있으며, 전통과 권위를 상징하는 나라로 자리잡고 있다. 왕도 프로글레스가 주요 도시이다.`,
  },
  {
    name: "신성 반즈탄 제국",
    tag: "서쪽 바다의 섬 제국",
  ...
  },
  {
    ...
    color: "#1A6B4A",
    accent: "#D5EDDF",
    content: `신성 반즈탄 제국의 침략에 대항하기 위해 맺어진 국가 연합. 성력 1002년에 성립됐다.\n\n성립 이후 국가 간의 큰 싸움은 거의 일어나지 않았지만, 최근 북방에서 마족의 대규모 침략을 받아 고전하고 있다. 이를 계기로 신성 반즈탄 제국이 다시 개전을 준비하고 있다는 소문도 돌고 있다.`,
  },
  {
    name: "키르디아 공화국",
...
const timeline: TimelineEvent[] = [
  ...
  { year: "200년경", events: [
    ...
    '세피로스, 에린디르 서방 수호 역할과 이명("신령")을 소하르에게 넘김',
    '"성도" 디아스론드 건설',
    '"신령" 소하르, 에린디르에 출현',
    '에린디르에 마족 대세력 침공',
    '"장폐의 도구" 집결',
  ...
  { year: "300년경", events: ['에루란 왕국 건국'] },
  { year: "370년경", events: ['에루란 왕국과 하트파스 왕국의 전쟁 (사자공子전쟁)'] },
  ...
  { year: "500년경", events: [
    ...
    '제1차 길마드 전쟁',
    '에루란 왕국과 파리스 왕국의 전쟁 (파리스 전쟁)',
    '파리스 왕국 패배',
  ]},
  { year: "600년경", events: [
    '에루란 왕국과 "돌의 거리" 바르데르의 전쟁',
    '"돌의 거리" 로그아니아 건설',
    '"기계의 거리" 카난 건설',
  ]},
  { year: "700년경", events: ['에루란 왕국의 각 지역이 자립하기 시작'] },
  { year: "705년",   events: ['라인 왕국 건국'] },
  { year: "719년",   events: ['반즈탄 제국 건국'] },
  { year: "722년",   events: ['제2차 길마드 전쟁'] },
  { year: "750년경", events: ['"마술 도시" 파리아스, 대지진으로 붕괴'] },
  { year: "799년",   events: ['반즈탄—히유린 일족, 마물 아스트로테에 의해 침략을 당함'] },
  { year: "813년",   events: ['"물의 거리" 그란=베르 건설'] },
  { year: "887년",   events: ['마술사 호트리, 금서 "두마의 서"의 일부를 발견'] },
  { year: "898년",   events: [
    '마물(바람에 의한 저주)이 에린디르에 휘몰아침',
    '에린디르 각지에서 마물·마족 목격 정보 증가',
  ]},
  { year: "921년",   events: ['"현자의 거리" 오카마 건설'] },
  { year: "923년",   events: ['바람의 마지막 결전'] },
  { year: "949년",   events: ['"유적의 거리" 두르가르, 반즈탄 제국에 복종'] },
  { year: "971년",   events: ['루아당의 언덕, 프로렌 길마드 지방에서 확인됨'] },
  { year: "984년",   events: [
    '엘크레스트·카렛지 건설, 마족에 의해 점령됨',
    '"마왕의 유산서"가 발견되어 엘크레스트·카렛지 보물고에 수납됨',
    '"공중 도시" 테니아 건설',
  ]},
  ...
  { year: "999년",   events: [
    '반즈탄 제국, 신성 반즈탄 제국으로 개칭',
    '신성 반즈탄 제국, 동방으로의 침공 시작',
  ]},
  { year: "1002년",  events: ['파리스 동맹 결성', '한마르비르의 묘, 자태를 드러냄'] },
  { year: "1004년",  events: [
    '영웅 가이아에 의한 전란 (마족 전쟁)',
    '파모루 왕 에루사핀데르의 부활이 저지됨',
    '에루란 왕국 국왕 여왕 에안나 암살 미수 사건',
    '에루란 왕국 국왕 에루트 13세 암살 미수 사건',
    '"공전의 신" 크롬그루르의 부활이 저지됨',
  ]},
  { year: "1005년",  events: ['"마왕" 베르베아이, 전투 동맹을 맺음'] },
  { year: "1006년",  events: [
    '신성 반즈탄 제국, "성도" 디아스론드의 "비밀 결사"가 다이나스타파르에 의한 "장폐의 도구" 탐색을 활성화함',
    '"신령" 소하르에 의한 "서청"이 미연에 방지됨 (최초의 재앙)',
    '엘크레스트·카렛지, 마족에 의해 재점령됨',
    '"공중 도시" 테니아 재건설',
  ]},
  { year: "1007년",  events: [
    '"에린디르의 방위선" 베넷, 신들의 명에 의해 서방 알디온 대륙으로 향함',
    '"크란=베르의 풍천사" 쥬리오·코코로나, 행방불명',
    '신성 반즈탄 제국 황제 제단에 대한 암살 미수 사건',
  ...
  { year: "1010년",  events: [
    '에루란 왕국 왕도 프로글레스에서 "전설의 스파이" 프렛차가 격퇴됐다는 소문',
    '디아스론드 신전이 "오카마" 대학의 설립을 선언',
  ]},
  { year: "1012년",  events: [
    '"대학 도시" 오카마, 대량의 마족들에게 침략당함',
    '에루란 왕국 왕도 프로글레스에서 마족 그시온에 의한 크리처 저지됨',
    '별의 알이 출현, 토벌됨',
  ]},
];
  ...
  return (
    <div>
      <p style={{ fontSize: "14px", lineHeight: 1.9, color: "#3a3a3a", marginBottom: 8 }}>
        에린디르 서방에는 많은 국가가 존재하지만, 그 중에서도 강대한 4개국이 있다.
      ...
      <p style={{ fontSize: "14px", lineHeight: 1.9, color: "#3a3a3a", marginBottom: 24 }}>
        ...
        신성 반즈탄 제국이 다시 개전을 준비하고 있다는 소문도 있어 예단을 허용하지 않는 상황이다.
      </p>
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        {countries.map((c, i) => (
          <div key={i} style={{
      ...
      <div style={{ marginTop: 20, padding: "16px 20px", background: "#F7F4EE", borderRadius: 8, border: "1px solid #E8E3DA" }}>
        ...
        <div style={{ fontSize: "14px", lineHeight: 1.85, color: "#555" }}>
          에린디르 서방에는 4대국 외에도 중요한 위치에 있는 도시가 있다. 특히{" "}
          <strong style={{ color: "#2a2a2a" }}>디아스론드</strong>는 에린디르 서방의 총 본산으로,
          어떤 나라도 무시할 수 없는 힘을 가지고 있다. 또한 역사학자들이 "대학 도시"라 부르는{" "}
          <strong style={{ color: "#2a2a2a" }}>오카마</strong>도 다른 지역에는 없는 특이한 도시라 할 수 있다.
        </div>
      </div>
    </div>
  );
...
function NotableSection({ color }: { color: string }) {
  return (
    <div>
      <p style={{ fontSize: "14px", lineHeight: 1.9, color: "#3a3a3a", marginBottom: 20 }}>
        앞서 소개한 국가나 도시 이외에도, 에린디르 서방에는 특징 있는 국가나 지역이 존재한다.
      </p>
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
...
function TimelineSection({ color }: { color: string }) {
  return (
    <div>
      <p style={{ fontSize: "14px", lineHeight: 1.9, color: "#3a3a3a", marginBottom: 20 }}>
        에린디르 대륙 서방의 주요 역사적 사건을 연대순으로 정리한 연표이다.
      </p>
