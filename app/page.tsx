...
const regions: RegionItem[] = [
  {
    name: "에린딜 대륙 서방",
    href: "/erindil-west",
    content: `약 800만 평방킬로미터의 광대한 지역. 서방 남쪽은 빙원, 북동쪽은 사막이 넓게 분포한다. 신들에 의해 여러 차례 큰 변혁을 받았기 때문에, 파상의 기복을 가진 광대한 저지가 중앙 부근에 펼쳐진다.\n\n목초 성장이 빠르며 소·말·염소 등의 목축이 왕성하다. 주요 농작물은 밀, 호밀, 귀리, 오트밀, 감자 등이다.\n\n문명은 지구의 15~16세기 유럽에 가까우며, 마법이 당연하게 사용되고 황야에는 위험한 몬스터가 존재한다. 대륙 각지에 신화·전설 시대의 유적이 남아 있으며, 유적의 유물과 네바프의 연금술 덕분에 일부 기술 레벨은 18세기 수준에 달한다.\n\n현재는 신성 반즈탄 제국, 에를랑 왕국, 파리스 동맹, 키르디아 공화국의 4국 세력이 크다.`,
  },
  {
    name: "에린딜 대륙 동방",
    content: `에린딜 서방의 동쪽, "무한의 사막"을 넘어 도달하는 땅. 진보한 문명과 광대한 영토를 가진 세세리아 태국, 유목민들의 나라 탈탈·한 제국, 동방 극동의 섬나라 다이와 군도의 3국이 알려져 있다.`,
  },
  {
    name: "알디온 대륙 동방",
    content: `에린딜 대륙 서방에서 넓은 바다를 넘어 도달하는 알디온 대륙의 동방 지역. 대소 다양한 국가들이 탈탈·한 제국과 패권을 다투는 지역이다. 최근 피니아 왕국의 왕녀 비아니 루티나베르·피니아니아가 대륙 통일을 이루었다고 한다.\n\n에린딜 대륙과 알디온 대륙 사이에는 "바다의 거북"이라 불리는 균열이 있으며, 특정 시기에만 건널 수 있다.`,
  },
  {
    name: "아스란",
...
const timeline: TimelineEvent[] = [
  ...
  { year: "799년",   events: ['번스터—히유린 일족, 마물 아스트로테에 의해 침략을 당함'] },
