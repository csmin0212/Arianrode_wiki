...
const kananStats = {
  population: "약 18만 명",
  raceComposition: [
    { race: "히유린",   pct: 45, color: "#2A5F9E" },
    { race: "엘다나안", pct: 18, color: "#1A6B4A" },
...
숲 속에 살며 소수의 네바프 직인들이 연금소를 경영하던 이 장소는 "땅의 시대"에서 살아남은 네바프들이 "불의 시대"의 엘다나안들의 집락이었다고 생각된다. 당시에는 숲에 둘러싸인 공예 도시라 불렸다. 공업의 발달과 함께 주변 숲은 벌채되어, 이전의 숲의 면모는 이제 없다.

파리스 동맹 결성에 있어서는 "유적의 거리" 라인과 함께 주도적인 역할을 맡았으며, 초대 동맹 평의회 의장을 냈다.`;

const kananCurrentStatus = `발달한 연금술로 인해 숲의 거리에서 기계의 거리로 바뀐 지금도, 거리에 관련이 있는 네바프와 엘다나안이 많이 볼 수 있다. 그들이 생산하는 연금 제품이나 마법 도구는 에린디르 전체에서도 높은 평가를 받고 있다.
...
const kananOrganizations: Org[] = [
  ...
  },
  {
    ...
    leader: "이리아스·뮈레레이",
    content: "카난의 연금철도 운영을 담당하는 회사. 중앙역에서 공업구에 이르는 철도를 관리한다. 사장 이리아스는 엘다나안의 남성으로, 관광용 PR과 서비스 제공에도 열심이어서 카난의 철도회사 3사 중 가장 인기가 높다.",
  },
  {
    name: "강철 연금병단",
    type: "군사 조직",
