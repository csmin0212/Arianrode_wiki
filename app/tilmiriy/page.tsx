...
function OrgsSection() {
  const orgs = [
    ...
    { name: "그레믈린 도적단", type: "범죄 조직", base: "불명", leader: "잭래빗", content: "틸미리이에 사는 그레믈린이나 렙라콘으로 구성된 도적 부대. 정기적으로 마쥬라니카로부터 이상한 광석을 모으고 있다. 각 지방의 도중에 함정을 걸어 물건을 빼앗거나, 도중에 함정을 쳐서 인간들을 깊이 밀어넣는다." },
...
function PeopleSection() {
  const people = [
    ...
    },
    {
      ...
      note: "틸미리이에 살아 버린 필보르의 여유 여행자. 성력 960년대에 도착했다고 하는 것이니까, 이미 50년 가까이 거주하고 있다. 요정들에 둘러싸인 생활이 몸에 들어와 버린 것이지만, 도시를 나오는 것도 싫지는 않다. 인간과 비슷한 성격으로, 새로 찾아온 인간을 안내하는 것이 취미이다.",
    },
  ];
  return (
    <div>
