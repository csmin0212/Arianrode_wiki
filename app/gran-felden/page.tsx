...
const parisEvents = [
  ...
  {
    name: "클란=베르의 사영웅",
    content: `성력 1004년, 클란=베르에 봉인되어 있던 물의 대정령왕이 해방된 것을 계기로, 마족의 음모가 밝혀지게 됐다. "부서진 영웅" 가이아를 모델로 "다음 시대의 막을 고하는" 부정 정화 활동을 시작한 것이 사건의 발단이었다. 이 사건은 마물과의 전쟁으로 이어졌으며, "클란=베르의 사영웅"이라 불리고 있다.`,
  },
  {
    name: "지하에 펼쳐지는 유적",
    content: `"유적의 거리" 라인 부근에는 주로 당대의 지형에서 유래한 유적 발굴이 많이 이루어지고 있다. 유적의 조사가 진행됨에 따라, 이것들이 "땅의 시대"의 네바프들의 손으로 만들어졌다는 것이 밝혀졌다. 이 일대는 밀집한 지하 제국의 잔재라고 하는 설도 있다. 지하에 구조물을 만든 네바프들에게 연결되는, 세계 각지에 지하 통로가 만들어져 있을 가능성도 있다고 한다.\n\n현재 가장 농도가 있는 것으로 알려진 것은 라프 대동굴 부근으로, "땅의 시대"의 지세가 정해지는 것은 아니지만, 추측되는 한, 북방의 산맥에서부터 방대한 광물 자원을 운반하는 수단을 갖추기 위해 네바프 문명을 지탱하는 것은 틀림없다고 보이고 있다. 동일하게 신성 반즈탄 제국이나 에루란 왕국 방면에도 지하 통로가 있다 하더라도 아무런 이상할 것이 없다.`,
  },
  {
    name: "마물의 습격",
  ...
  {
    name: "동맹 평의회 선거",
    content: `파리스 동맹 평의회는 2년에 한 번, 의장을 결정하는 선거를 실시하고 있다. 최근에 치러진 선거에서는 클란=베르의 의장 후보인 마티아스가 당선됐다. 현 의장은 무즈라는 인물도 선거를 위해 입후보하고 있다.\n\n마티아스는 이전 선거에서 평가되어 의장에 선출됐지만, 이번 선거에서 역할에 대한 의구심도 있어, 의장을 사임(*) 한 후 이번 선거에 입후보(역할)으로 입후보했기 때문에, 만일 선출된다면 하겠다는 생각이라고.`,
  },
];
...
그 후, 파리스 왕국이 출현하여 이에 패배함으로써 종속국이 됐다. 건국으로부터 약 200년 후, 성력 500년 전후에 파리스 왕국의 멸망과 동시에 왕도와 주변 토지를 영토로 독립. 이후 에루란 왕국에 이어, 혹은 이에 필적하는 세력을 가지게 됐다.
...
const capitalData = {
  ...
  stats: [
    ...
    { label: "종교",         value: "7대 신 신앙 (아케나라브 주신)" },
    { label: "언어",         value: "공통어" },
    { label: "기후",         value: "한랭" },
...
const capitalHistory = `파리스 동맹뿐만 아니라 에린디르 서방 전체를 통틀어도 오랜 역사를 자랑하는 그랑펠덴 왕국의 왕도. 그것이 "옛 왕도"라고도 불리는 그랑펠덴의 거리다.

왕도 그랑펠덴이 탄생한 것은 왕국 건국으로부터 약 100년 후. 북방 평원을 넘어 중원까지 판도를 넓히는 중에서였다.

원래는 에린디르 중원으로의 전략 거점으로서 태어난 성곽 도시였으며, 북방을 흐르는 벤갈드 강으로부터 처음에는 벤갈드 성곽이라 불렸다. 에린디르 중원의 근거지가 어느 정도 갖춰지자, 벤갈드 강의 이점에서 이 성곽 도시에 많은 사람들이 모여들었으며, 이내 무역 도시로서의 기능도 갖추게 됐다.
...
const facilities: Facility[] = [
  ...
  },
  {
    name: "왕립도서관",
    ruby: "おうりつとしょかん",
    content: `왕성 근처에 세워진 큰 도서관. 입관 허가는 원래 신전이 발행하며, 원래는 왕성과 함께 설치될 예정이었지만 왕성의 확장과 함께 입관 허가 수속이 너무 번거로워져, 왕성과는 별도 건물로 건설됐다.\n\n오랜 역사를 자랑하는 그랑펠덴의 역사 자료가 이곳에 집중되어 있으며, 에린디르에서도 둘째가라면 서러울 자료의 보고이다. 타 국가에서도 학자나 연구자들이 방문한다. 옛날에는 왕성의 관리 하에 있었지만, 현재는 신전에 업무를 위탁하고 있다.`,
  },
  {
    name: "왕국연금술협회",
    ruby: "おうこくれんきんじゅつきょうかい",
    content: `그랑펠덴 왕국이 경영하는 국내의 연금술 협회. 회장은 에리야·아린가므, 전 18개 창고의 거대한 탑을 자랑하며, 탑의 총칭은 "마탑"이라 불린다.\n\n시설은 오래됐지만 라프 대동굴이나 신성 반즈탄 제국의 선진 연구 시설에 비하면 낡아도, 그만큼 우수한 인재가 다수 재직하고 있다. 그랑펠덴 주변 유적의 발굴을 추진하는 것 외에, 의료 관련 연구가 진행되고 있다. 특히 포션을 비롯한 약초계 아이템의 연구가 과제이며, 현재 시장에서 유통하는 종류의 포션은 모두 이곳의 조제법으로 제조 가능하게 됐다. 도시 내에 합쳐서 그 수는 50개를 넘는다고 한다.`,
  },
  {
    name: "용의 골격정",
    ruby: "りゅうのがいこつてい",
...
const characters: Character[] = [
  ...
  },
  {
    ...
    race: "히유린 (하프 엘다난)", gender: "남", age: 34,
...
function ParisSection() {
  return (
    <div>
      <SecTitle title="개요" />
      <Prose text={`파리스 동맹은 에린디르 중원에 있는 국가들이 신성 반즈탄 제국에 대항하기 위해 연합한 동맹체이다. 주립 7개국을 중심으로 각각 역사와 문화가 다른 나라들이 교류하고 있다.\n\n파리스 동맹은 에린디르 서방의 중원에 있는 국가 연합이다. 남방에서 세력을 강화하는 신성 반즈탄 제국에 대한 억지력이 되도록 성력 1002년에 발족됐다. 그 본체는 넬수스 강 유역의 중원 도시 동맹으로, 신흥의 세력이면서도 경제 대국으로서 서방 국가들의 주목을 모으고 있다.\n\n정치적 입장의 중심에는 "유적의 거리" 라인을 비롯하여, "기계의 거리" 카난, "물의 거리" 클란=베르 등의 넬수스 강 유역 도시와 중핵 7국, 그 주변 도시들이 있다.`} />

      <SecTitle title="기후와 풍토" />
      <Prose text={`3개의 강 사이에 있는 이 일대는 에린디르 서방 중부에서 "중원(中原)"이라 불리는 평탄한 땅이다. 풍부한 산림과, 남방은 다습한 토지이다. 약간의 저지에서 서해에서의 따뜻한 바람의 영향으로 온화한 기후가 되고 있다. 북방에서 냉기가 흘러내리고, 일부에서는 겨울에도 눈이 내리는 경우가 드물다.\n\n지질은 많이 이탄질이지만, 군데군데 화성암의 대지나 석회암, 화강석 지역도 있고, 클란=베르 주변에는 붉은 사암 지역도 볼 수 있다. 각지에서 화산 외에 빙정암 등의 희귀한 광석이 채굴되며, 북방을 흐르는 강의 거대한 벨루아그 협곡 계곡을 이용해 무역을 활발히 행하고 있다.`} />

      <SecTitle title="타국과의 관계" />
      <Prose text={`중원에는 파리스 동맹에 참가하지 않은 도시 국가들도 있다. 이러한 국가들은, 현재로서는 대체로 적대적이지 않다. 하천을 교통로로 이용하여 서로 상업 목적의 교류를 하는 주요 3개 강 유역 및 남쪽의 라셀 강까지 광범위하게 이루어지고 있다. 파리스 동맹에 가입하고 있는지 여부와 관계없이, 통행이 용이하며 통행세에도 차이가 있다. 모험자는 모험자의 증거를 소지하여 길드가 일괄 관리하고 있어, 모험자의 증거를 가진 자는 거의 대부분의 도시 사이를 이동할 수 있다.\n\n라셀 강을 경계로 하여, 남방의 중원 평야에는 신성 반즈탄 제국의 영토가 인접하고 있다. 중원 국가들은 한편으로 제국의 영향력을 경계하면서도 동맹의 방위 강도를 높이고 있어, 동맹의 대제국 방위선이 될 것이라 예상된다.`} />
...
export default function GranFeldenWiki() {
  ...
  const renderContent = () => {
    switch (activeId) {
      case "paris":      return <ParisSection />;
