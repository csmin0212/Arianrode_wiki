...
function ParisSection() {
  return (
    <div>
      <SecTitle title="개요" />
      <Prose text={`파리스 동맹은 에린디르 중원에 있는 국가들이 신성 번스터 제국에 대항하기 위해 연합한 동맹체이다. 주립 7개국을 중심으로 각각 역사와 문화가 다른 나라들이 교류하고 있다.\n\n파리스 동맹은 에린디르 서방의 중원에 있는 국가 연합이다. 남방에서 세력을 강화하는 신성 번스터 제국에 대한 억지력이 되도록 성력 1002년에 발족됐다. 그 본체는 넬수스 강 유역의 중원 도시 동맹으로, 신흥의 세력이면서도 경제 대국으로서 서방 국가들의 주목을 모으고 있다.\n\n정치적 입장의 중심에는 "유적의 거리" 라인을 비롯하여, "기계의 거리" 카난, "물의 거리" 클란=베르 등의 넬수스 강 유역 도시와 중핵 7국, 그 주변 도시들이 있다.`} />
