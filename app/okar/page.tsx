...
const characters: Character[] = [
  ...
  },
  {
    ...
    eyes: "검은색",
    skin: "황색",
    content: "대학 도시 오카의 학생회장을 맡고 있는 어션. 두뇌가 명석하지만 그것을 자랑하는 언동이 눈에 띄어, 경계받는 경우도 많다. 그런 그이지만 본심으로는 학생들의 직무에 힘쓰는 성실함도 지니고 있다. 은밀한 취미는 폭발물(폼)이며, 가트루드에게 마음을 기탁하고 있는 것 같다.",
  },
  {
    name: "가트루드 크로이첼",
