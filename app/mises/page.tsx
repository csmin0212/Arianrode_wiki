...
const districts = [
  {
    name: "중앙구",
    content: "킬드가 신탁을 받은 성지가 있는 구역. 그랑아인 신전을 필두로 7대신 신전이 모두 이 구역에 위치한다. 신전 주변에는 행정 관련 중요 시설이 세워져, 도시의 모든 주민에게 영혼의 안식처가 되기도 한다. 신전 주위에는 건국 기념 공원도 있어 녹지 공간으로 가꿔져 있다.",
  },
  {
    name: "4개의 대로",
...
const facilities: Facility[] = [
  {
    name: "미스 신전",
    content: "거리 중심에 세워진 신전. 킬드가 그랑아인의 신탁을 받은 것으로 알려진 성지이며, 그 주변 성역이 미스 건설의 출발점이다. 미스 신전은 주로 그랑아인을 봉납하지만, 파리스 동맹의 신전을 참고하여 7대신 신전이 모두 병설되어 있어 다른 신들도 함께 모신다. 신전 주위에는 모험자들의 숙박지 및 의뢰처가 있다.",
  },
  {
    name: "미스 유적",
...
const characters: Character[] = [
  {
    ...
    eyes: "검은색",
    skin: "황갈색",
    content: "키르디아 공화국의 건국자이자 현 주석. 원래는 병사였으며, 동료들과 연대하여 건국에 이바지했다. 무력을 사용하지 않고 끈질긴 교섭으로 주변 각 부족을 아군으로 만들었다. 한편 '고대의 유목 생활 방식'을 고수하고 있어, 유목 문화에 애착이 강하다. 번스터 제국에 대한 경계는 게을리하지 않고, 반(反)킬드파에 대한 대응에도 고심하고 있다.",
  },
  {
    name: "하리두르",
    role: "키르디아 주석 보좌",
