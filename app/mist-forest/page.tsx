  ...
  return (
    <div style={{ display: "flex", height: "100vh", fontFamily: "'Noto Sans KR', sans-serif", background: "#F7F4EE", color: "#2a2a2a" }}>
      ...
      <nav style={{
        ...
        <div style={{ padding: "16px 20px", borderTop: "1px solid rgba(255,255,255,0.07)", fontSize: "11px", color: "#3A5A4A" }}>
          <a href="/" style={{ color: "#4A7A6A", textDecoration: "none" }}>← 이상동몽 위키</a>
        </div>
      </nav>
