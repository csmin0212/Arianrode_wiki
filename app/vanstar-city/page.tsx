...
const vanstarCityFacilities: Facility[] = [
  ...
  {
    name: "토니오의 전송소",
    content: "신전 관계 이외에는 친하지 않지만, 전송 서비스를 행하는 회사. 제도의 뱅스터를 본거지로, 에린딜 서방으로의 주요 거점을 연결하는 전송 거점으로 삼고 있다. 특히 대형 화물의 수송이나 비밀 이동에 관해 광범위하게 서비스를 제공하고 있지만, 1회의 전송 비용은 1000G 정도로, 일반 시민에게는 쉽게 이용하기 어려운 가격이다. 경영자 토니오는 군사 관계의 일은 받지 않는다.",
  },
];
...
const vanstarCityCharacters: Character[] = [
  ...
  },
  {
    ...
    race: "엘다난", gender: "여", age: "불명 (200세 이상으로 추정)",
