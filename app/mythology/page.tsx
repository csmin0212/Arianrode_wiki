      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 14 }}>
        {ancientDragons.map(d => (
          <div key={d.id} style={{
            ...
            borderLeftWidth: 4, borderLeftColor: d.accent,
          }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
              <span style={{ background: d.accent, color: "#0A0808", fontSize: 10, fontWeight: 700, padding: "2px 7px", borderRadius: 4, flexShrink: 0 }}>{d.title}</span>
              <span style={{ color: d.accent, fontWeight: 700, fontSize: 16, fontFamily: "'Noto Serif KR', serif" }}>{d.name}</span>
            </div>
            <p style={{ margin: 0, color: "#C8B870", fontSize: 13, lineHeight: 1.85 }}>{d.desc}</p>
          </div>
        ))}
      </div>
    </section>
...
const evilGods = [
  {
    ...
    lore: [
      {
        heading: "대신전의 벽화",
        text: "에린에서 '가장 위대한 예술가'로 칭송받은 클란=벨의 화가 미루크로가는 대신전 천장의 거대 벽화 의뢰를 받았다. 그러나 작업에 착수하고도 영감이 떠오르지 않아 3년이, 5년이 지나도 완성에 이르지 못했다. 고뇌 끝에 그는 스스로 목숨을 끊었고, 달려온 제자들이 시신 곁에서 회색 빛 피부의 여성이 '영혼을 받았다'고 중얼거리는 것을 목격했다고 전한다.",
      },
      {
        heading: "질투의 불꽃을 새기는 자",
        text: "모리안은 회색 머리카락과 눈, 회색 피부를 가진 사신이다. 두 자루의 창을 양손에 들고 온화한 미소를 띤 전사의 모습을 취하며, 변신술을 특기로 하여 '까마귀의 여왕'이라고도 불린다. 신화에 따르면 신의 사자와 사랑에 빠져 그 사랑이 이루어지지 않자 사자를 죽인 뒤 스스로 마계로 떨어졌다고 한다.",
      },
    ],
    skills: [
      {
        ...
        slMax: "1",
        condition: "씬 1회",
        effect: "〈페이즈：모리안〉으로 취득 가능. 리액션 판정에 +2D. 이 효과는 대상이 1점 이상의 HP를 잃을 때까지 지속. 다른 인간·동물의 모습으로 변신해 공격을 회피하기 쉽게 하는 천혜 스킬.",
      },
      {
        name: "질투의 저주",
        nameJp: "嫉妬の呪詛",
        ...
        slMax: "1",
        condition: "시나리오 1회",
        effect: "〈페이즈：모리안〉으로 취득 가능. 언제든지 사용 가능. 대상이 행하는 〔감지〕 판정에 -1D. 대상이 NPC인 경우 추가로 질투심에 따라 행동하게 된다. 이 효과는 시나리오 종료까지 지속. GM이 해제 조건을 별도 설정해도 좋다.",
      },
      {
        name: "질투의 불꽃",
        nameJp: "妬みの炎",
        ...
        cost: "—",
        slMax: "상한 없음",
        effect: "〈페이즈：모리안〉으로 취득 가능. 배드 스테이터스를 받고 있을 때 유효. 행하는 공격의 데미지에 +〔SL〕. 이 효과는 메인 프로세스 종료까지 지속. 질투의 마음으로 공격력을 높이는 천혜 스킬.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "하나를 얻으면 둘을 탐한다",
        text: "가난하고 굶주렸던 키인힐은 어느 날 악마 같은 여성에게 '원하는 것을 말하라, 원하지 않으면 아무것도 얻을 수 없다'는 말을 듣게 된다. 그 말에 따라 꽃을 팔고 빵을 얻는 것에서 시작한 그는, 이윽고 귀족과 결탁해 세금을 면제받고 투기를 통해 막대한 부를 쌓았다. 하지만 가난한 자들을 돕는 일은 포기했다. 결국 그의 행보가 부유층의 지지를 잃었고, 영혼은 사신에게 데려가졌다.",
      },
      {
        heading: "욕망에 빠진 마녀",
        text: "마하딜그는 짙은 머리카락과 눈, 피범벅 된 붉은 도끼를 든 채 붉은 말을 타고 전장을 달리는 사신이다. 오스발드인이라 불리는 상인 집단과 깊이 연관되어 '전쟁의 여신'이라고도 불린다. 신화에 따르면 에린델을 지배하려는 강렬한 욕망으로 신에게 석화되어 고대 유적 지하 깊숙이 봉인되어 있다고 한다.",
      },
    ],
    skills: [
      {
        ...
        slMax: "1",
        condition: "씬 1회",
        effect: "〈페이즈：마하딜그〉로 취득 가능. 장면：장면〔선택〕 대상의 사거리를 '분류：마술'에서 〔사거리：시야〕로 변경. 이 효과는 메인 프로세스가 종료할 때까지 지속. 마하딜그의 욕망을 이루는 힘으로 효과 범위를 확대하는 천혜 스킬.",
      },
      {
        name: "파멸의 유혹",
        nameJp: "破滅の誘惑",
        ...
        slMax: "1",
        condition: "씬 1회",
        effect: "〈페이즈：마하딜그〉로 취득 가능. 대상이 행하는 판정 직전에 사용. 대상의 욕망을 자극해 정상적인 판단력을 잃게 만드는 천혜 스킬.",
      },
      {
        name: "욕망의 먹이",
        nameJp: "欲望の餌",
        ...
        slMax: "상한 없음",
        condition: "시나리오 1회",
        effect: "〈페이즈：마하딜그〉로 취득 가능. 대상은 난이도〔10+SL〕의 〔정신〕 판정. 실패한 캐릭터는 자신의 엔게이지로 전송된다. 재보·명예 등의 환상을 보여줘 대상을 스스로의 먹이로 끌어들이는 천혜 스킬.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "현왕 크레지빌",
        text: "에라나림의 왕 크레지빌은 어린 시절 어리석고 경솔한 인물이었다. 그러나 젊은 소녀와 만나 자신을 끊임없이 의심하는 충고를 받으면서 점차 신중해졌고, 왕이 된 후에는 현명하고 고결한 인물로 칭송받았다. 하지만 사신의 책략으로 민심이 흉흉해졌고, 긴 원정을 마치고 돌아왔을 때 지지를 잃어 도성 입장을 거부당했다. 도망친 곳에서도 의심받아 결국 길가에서 쓰러졌다고 전해진다.",
      },
      {
        heading: "불화를 일으키는 자",
        text: "시의의 여신 미발은 허영의 여신 브레그와 함께 '신의 아버지' 다그데모아를 유혹하려 했다고 전해지는 사신이다. 깨끗한 소녀의 모습으로 나타나며, 상대의 행동을 탓하거나 실패를 남의 탓으로 돌려 인심에 의심을 심어주는 것을 특기로 한다. 신화에 따르면 브리간티아의 마법 법정에서 패배해 마계에 봉인되었고, 그 때문에 달이 차면 사라진다고 전해진다.",
      },
    ],
    skills: [
      {
        ...
        slMax: "1",
        condition: "시나리오 1회",
        effect: "〈페이즈：미발〉로 취득 가능. 대상이 행하는 〔정신〕 판정에 -1D. 대상이 NPC인 경우 추가로 의심심에 따라 행동하게 된다. 이 효과는 시나리오 종료까지 지속. GM이 해제 조건을 별도 설정해도 좋다.",
      },
      {
        name: "달을 숨기는 술법",
        nameJp: "月隠しの術",
        ...
        slMax: "1",
        condition: "씬 1회",
        effect: "〈페이즈：미발〉로 취득 가능. 〔페이즈：미발〕을 사용한 전투에서만 사용 가능. 데미지 증가를 행한다. 마법 공격의 데미지에 +〔SL×2〕. 이 효과는 라운드 종료까지 지속. 흡수한 힘을 자신의 마술에 사용하는 천혜 스킬.",
      },
      {
        name: "불신의 미혹",
        nameJp: "不信の迷い",
        ...
        slMax: "상한 없음",
        condition: "씬 1회",
        effect: "〈페이즈：미발〉로 취득 가능. 대상은 난이도〔10+SL〕의 〔정신〕 판정. 실패한 캐릭터는 커버를 행할 수 없다. 이 효과는 라운드 종료까지 지속. 불신의 마음으로 타인을 지키는 일을 주저하게 만드는 천혜 스킬.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "요정의 모자",
        text: "아레스타 귀족의 저택에 특이한 꽃이 들어왔다. 루디온 산맥 동쪽에서 온 상인이 가져온 이 꽃은, '딸의 모자'를 의미하는 아드니안이라 불리며 시장에서 유통되었다. 구근 선물 매매로 많은 부자가 생겨나고 새 품종이 고가에 팔리는 투기 열풍이 불었다. 자산을 총동원한 아드니안은 재산을 더욱 구근에 쏟아부었다. 그러나 갑작스러운 폭락이 찾아왔고, 법 개정과 무허가 기업 단속이 시작되면서 자금이 급정지했다.",
      },
      {
        heading: "허영을 두르는 자",
        text: "브레그는 아름다운 의상과 장식품으로 치장한 미녀의 모습을 취하는 사신이다. 거짓과 위선으로 상대를 심리 조종하고 어떠한 방법으로도 타인을 해치는 것을 마다하지 않는다고 전해진다. 시의의 여신 미발과 함께 '신의 아버지' 다그데모아를 유혹하려 했으나, 마법의 여신 브리간티아에게 들켜 마계에 봉인되었다.",
      },
    ],
    skills: [
      {
        ...
        cost: "—",
        slMax: "상한 없음",
        effect: "〈페이즈：브레그〉로 취득 가능. 데미지 증가를 행한다. 〈초대형〉을 취득한다. 또한 백병 공격의 데미지에 +〔SL×2〕. 허영의 비대화에 맞춰 몸도 거대화하는 천혜 스킬.",
      },
      {
        name: "화려한 옷",
        nameJp: "華美の衣",
        ...
        slMax: "상한 없음",
        condition: "씬 1회",
        effect: "〈페이즈：브레그〉로 취득 가능. 데미지 경감을 행한다. 받은 데미지 롤 직후 사용. 그 데미지에 -〔SL×10〕. 겉보기에만 화려한 옷, 얄팍한 허영심으로 공격을 버티는 천혜 스킬.",
      },
      {
        name: "허영의 저주",
        nameJp: "虚栄の呪詛",
        ...
        slMax: "1",
        condition: "시나리오 1회",
        effect: "〈페이즈：브레그〉로 취득 가능. 대상이 행하는 〔지력〕 판정에 -1D. 대상이 NPC인 경우 추가로 대상은 자신의 지시에 따라 행동하게 된다. 이 효과는 시나리오 종료까지 지속. GM이 해제 조건을 별도 설정해도 좋다.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "사신룡의 숨결",
        text: "크롬쿠루는 3종류의 숨결을 지닌다고 전해진다. 하나는 독의 숨결로, 이 독에 침범된 자는 격렬한 고통에 몸부림치다 뼈까지 썩어 사망한다. 두 번째는 힘의 숨결로, 막대한 힘과 생명력을 부여하며 사신의 가호를 받는 자로서 이 숨결에 잠길 수 있다. 세 번째는 마음의 증오를 증폭시키는 검은 숨결이다. 이 꽃에서 '크롬쿠루의 피'라 불리는 환각약이 만들어지며, 교단은 이 약으로 어린 시절부터 암살에 특화된 전사를 기른다고 전해진다.",
      },
      {
        heading: "증오의 독을 뿜는 자",
        text: "야위고 마른 노인의 모습으로 나타나는 크롬쿠루는, 구불구불한 두 자루의 반검을 양손에 들고 눈도 깜빡이지 않을 정도의 빠른 연속 공격을 특기로 삼는다. 가장 큰 특징은 고대 용의 힘 중 하나인 '검은' 마르쿠트의 힘을 빼앗은 것이다. 이 대가로 사신은 현재 마계에 봉인되어 있지만, 지상에 치유 기운을 발산하고 증오로 가득 찬 봄을 키워내는 힘을 지닌다고 전해진다.",
      },
    ],
    skills: [
      {
        ...
        slMax: "상한 없음",
        condition: "씬 1회",
        effect: "〈페이즈：크롬쿠루〉로 취득 가능. 무기 공격의 명중 판정과 동시에 사용. 데미지 증가를 행한다. 그 공격의 데미지에 +〔SL×10〕. 증오로 무기의 위력을 높이는 천혜 스킬.",
      },
      {
        name: "증오의 저주",
        nameJp: "憎悪の呪詛",
        ...
        slMax: "1",
        condition: "시나리오 1회",
        effect: "〈페이즈：크롬쿠루〉로 취득 가능. 대상이 행하는 〔의지〕 판정에 -1D. 대상이 NPC인 경우 추가로 증오에 따라 행동하게 된다. 이 효과는 시나리오 종료까지 지속. GM이 해제 조건을 자유롭게 설정해도 좋다.",
      },
      {
        name: "증오의 가시",
        nameJp: "憎悪の針",
        ...
        cost: "—",
        slMax: "상한 없음",
        effect: "〈페이즈：크롬쿠루〉로 취득 가능. 공격으로 1점 이상의 HP 데미지를 입힌 경우 대상에게 〔위압〕〔독〕을 부여. 〔독〕의 효과 강도는 SL이 된다. 이 효과는 메인 프로세스 종료까지 지속. 증오로 상대를 갉아먹는 천혜 스킬.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "하늘을 향한 남자",
        text: "에르클레스트의 천재 학자 스니베오라는 학식이 뛰어남에도 오만한 태도로 다른 학자들에게 자신의 의견을 강요해 결국 대학에서 쫓겨났다. 마술과 마계에 빠진 그는 결국 인마(火槍)를 완성시켜 천계를 향해 발사할 계획을 세웠다. 하지만 세 번째 발사 순간 대폭발이 발생했고, 검은 연기가 하늘로 올라가는 가운데 그의 모습은 사라졌다. 그는 오만의 사신 인디마의 눈에 들어 마계에서 보내오는 분노에 조종당하고 있었다.",
      },
      {
        heading: "오만한 살육자",
        text: "인디마는 사신들 중 왕으로 불리는 강대한 사신이다. '패력왕'이라는 이름을 갖고 있으며, 검은 피부에 거대한 검을 등에 짊어진 장년 남성으로 묘사된다. 신들의 왕 아켄라브와 일대일로 맞설 수 있을 만큼 강력하지만, 고반논의 마법 쇠사슬에 묶여 있다 전해진다. 인디마의 의지는 강력하지만, 마계에서 배어나오는 원한만이 인간을 타락시킨다고 한다.",
      },
    ],
    skills: [
      {
        ...
        slMax: "1",
        condition: "시나리오 1회",
        effect: "〈페이즈：인디마〉로 취득 가능. 대상이 행하는 〔민첩〕 판정에 -1D. 대상이 NPC인 경우 추가로 오만하게 행동하게 된다. 이 효과는 시나리오 종료까지 지속. GM이 해제 조건을 자유롭게 설정해도 좋다. 저주로 대상의 자존심을 비대화해 존대하게 행동시키는 천혜 스킬.",
      },
      {
        name: "오만의 갑옷",
        nameJp: "傲慢の鎧",
        ...
        cost: "—",
        slMax: "상한 없음",
        effect: "〈페이즈：인디마〉로 취득 가능. 【물리 방어력】과 〔마법 방어력〕 양쪽 리액션 판정에 +1D. 이 효과는 씬 종료까지 지속. 오만한 마음의 강함을 물리와 마법을 막는 갑옷으로 변환하는 천혜 스킬.",
      },
      {
        name: "존대한 자세",
        nameJp: "尊大なる構え",
        ...
        cost: "—",
        slMax: "상한 없음",
        effect: "〈페이즈：인디마〉로 취득 가능. 행하는 대기 선언과 동시에 사용. 데미지 증가를 행한다. 공격의 데미지에 +〔SL〕. 이 효과는 라운드 종료까지 지속. 존대하게 적에게 대기하여 대담한 공격을 행하는 천혜 스킬.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "사교도 사냥",
        text: "성력 730년, 에루란은 침묵의 빙원에서 부는 악한 바람의 영향으로 냉해와 흉작이 이어졌다. 역병이 퍼지기 시작하자 공포의 사신 트리아라크를 신봉하는 교단의 짓이라는 소문이 퍼져 사교도로 의심받는 자들이 고발당했다. 사교도로 신고된 이들은 자백이 없을 경우 생채로 처형되었다. 이 광기는 10년간 이어졌고, 이 시기에 신의 이름 아래 처형된 자는 에루란 전역에서 수만 명에 달한다고도 전해진다.",
      },
      {
        heading: "알려지지 않은 사신",
        text: "사자의 영혼과 육체를 조종하는 네크로맨서에게 신봉되는 공포의 신 트리아라크는, 누구에게도 미지의 사신이다. '어둠의 공자'라는 이름 외에는 알려진 것이 거의 없으며, 얼굴이 보이지 않는 칠흑의 후드를 쓴 모습으로 묘사된다. 신들과의 전투에서 어떤 역할을 했는지조차 알 수 없이 전설만 이어져 내려오며, 에린델 북방의 침묵의 빙원 혹은 죽은 자의 늪 일대에 숨어 있다고 전해진다.",
      },
    ],
    skills: [
      {
        ...
        slMax: "상한 없음",
        condition: "씬 1회",
        effect: "〈페이즈：트리아라크〉로 취득 가능. 공격으로 대상에게 1점 이상의 HP 데미지를 입힌 경우, 그 캐릭터를 SL×5m 이내 장소로 이동시킬 수 있다. 엔게이지에서 이탈 가능. 봉인의 영향을 받지 않는다. 이 효과는 메인 프로세스가 종료할 때까지 지속.",
      },
      {
        name: "공포의 종",
        nameJp: "恐怖の鐘",
        ...
        slMax: "상한 없음",
        condition: "씬 1회",
        effect: "〈페이즈：트리아라크〉로 취득 가능. 대상은 난이도〔10+SL〕의 〔정신〕 판정. 실패한 캐릭터가 행하는 판정에 -1D. 이 효과는 라운드 종료까지 지속. 응시한 상대에게 공포를 불러일으키는 천혜 스킬.",
      },
      {
        name: "사령의 저주",
        nameJp: "死霊の呪詛",
        ...
        slMax: "1",
        condition: "시나리오 1회",
        effect: "〈페이즈：트리아라크〉로 취득 가능. 대상이 행하는 〔근력〕 판정에 -1D. 또한 대상이 사망한 경우 '분류：언데드'로서 HP를 가지고 부활한다. PC의 경우 '분류：언데드'가 된 이후 NPC가 된다. 자세한 내용은 GM이 결정. 이 효과는 시나리오 종료까지 지속.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "세르노그의 독손",
        text: "에린에서는 태어날 때부터 팔의 일부가 검게 변해 있는 아이가 드물게 태어난다. 이는 부패의 신 세르노그의 저주라 전해진다. 루키아노스의 기적 이야기에 등장하는 '부패의 팔' 사라할은, 저주받은 팔로 태어나 긴 세월에 걸쳐 검은 얼룩이 온몸으로 퍼졌다. 그녀가 만지는 것은 즉시 썩었고, 먹으면 강렬한 향을 내뿜는 기이한 물체로 변해 사람들에게 기피당했다. 어느 날 루키아노스가 그녀의 저주받은 팔에 축복의 말을 불어넣자 점차 변화가 시작되었다.",
      },
      {
        heading: "부패의 신",
        text: "세르노그는 죽음과 부패를 가져오는 사악한 소신이다. 썩은 낫을 손에 들고 대지를 독으로 변화시키며, 그 숨결로 주변에 죽음의 오염을 퍼뜨린다. 그의 죽음의 숨결을 마신 자는 동공이 풀리고 썩어 넘어지며, 그 지역의 동물들은 사악화해 사신의 동료가 된다. 외모는 남성이며, 머리카락·눈썹·손가락 마디에 검정 빛이 돌고, 몸통 중앙에 돌기 같은 돌출이 있으며, 얼굴은 해골 그 자체에 가깝다고 한다.",
      },
    ],
    skills: [
      {
        ...
        cost: "—",
        slMax: "상한 없음",
        effect: "〈페이즈：세르노그〉로 취득 가능. 대상이 〔독〕을 받고 있을 때 유효. 〔SL×5〕점의 MP 로스를 부여. 독을 정신에 침식시키는 천혜 스킬.",
      },
      {
        name: "무기부식",
        nameJp: "武器喰食",
        ...
        cost: "—",
        slMax: "상한 없음",
        effect: "〈페이즈：세르노그〉로 취득 가능. 대상에게 백병 공격을 행한다. 이 공격으로 대상에게 데미지를 입힌 경우, 대상이 행하는 공격의 데미지에 -〔SL×2〕(최저 0). 이 효과는 라운드 종료까지 지속. 닿은 무기를 일시적으로 부식시켜 위력을 떨어뜨리는 천혜 스킬.",
      },
      {
        name: "부패의 식탁",
        nameJp: "腐敗の食卓",
        ...
        slMax: "1",
        condition: "시나리오 1회",
        effect: "〈페이즈：세르노그〉로 취득 가능. 대상은 〔종별：식료〕〔종별：요리〕의 효과를 사용할 수 없다. 이 효과는 시나리오 종료까지 지속. GM이 해제 조건을 자유롭게 설정해도 좋다. 손에 든 음식을 썩게 만드는 저주를 거는 천혜 스킬.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "말의 마력",
        text: "북방의 명군 레드윈의 치세 중 가장 치열한 격전으로 알려진 트윔·아·투아의 전투에서, 레드윈 왕이 이끄는 그란펠덴 군 800기에 대해 포모르의 잔병은 불과 40여명을 남긴 상황이었다. 코너를 몰린 포모르를 이끈 타워트마하는 허언의 사신 오그마에게 기도해 힘을 얻었다. 이 교묘한 연설로 사신의 가호를 믿은 부하들이 분기했고, 20배의 군세에도 한 발도 물러서지 않고 끝까지 싸워 쓰러졌다. 전투가 끝났을 때 그란펠덴의 정예 기사들은 100에 못 미치는 적밖에 쓰러뜨리지 못했다고 한다. 레드윈 왕은 적에게 진혼을 바치는 동시에 그 확고한 의지를 기리며 트윔·아·투아에 비석을 세우도록 명했다.",
      },
      {
        heading: "허언을 다루는 자",
        text: "오그마는 신성왕을 섬겼던 엘다였다. 소 80마리 분의 괴력을 지닌 전사의 체격이지만 한편으로 시 창작을 사랑하는 섬세한 예술가이기도 했다. 어느 날 브리간티아의 저택에 비장된 마도구에 손댔다가 신성왕에게 해당 마법의 사용을 금지당하자 불만을 품고 반기를 드는 엘다 일파가 되었다. 전장에서 영감을 받아 그 몸을 사신에게 바쳤다고 한다. 오그마는 변설이 뛰어나 말을 잘 다루었다. 그가 발하는 말은 검이 되기도 하고 마법이 되기도 했다. 허언의 사신으로서, 구변으로 상대를 유혹하는 사기꾼에게 힘을 주며 전장에서 병사를 고무하는 웅변가에게도 힘을 부여한다.",
      },
    ],
    skills: [
      {
        ...
        cost: "—",
        slMax: "1",
        effect: "〈페이즈：오그마〉로 취득 가능. 대상이 행하는 메이저 액션 판정에 +2D, 회피 판정에 -1D. 이 스킬은 자신을 대상으로 선택할 수 없다. 대상은 이 효과를 거부할 수 없다. 이 효과는 씬 종료까지 지속. 말로 대상을 조종해 고취시키고, 결사적인 전투를 하게 만드는 천혜 스킬.",
      },
      {
        name: "필살의 거짓말",
        nameJp: "必殺の嘘",
        ...
        cost: "—",
        slMax: "상한 없음",
        effect: "〈페이즈：오그마〉로 취득 가능. 대상이 데미지 증가를 행한다. 대상이 행하는 공격의 데미지 롤 직전에 사용. 그 공격의 데미지에 +〔SL×5〕. 이 스킬은 자신을 대상으로 선택할 수 없다. 또한 대상은 이 효과를 거부할 수 있다. 거짓말로 대상에게 치명상을 줄 기회를 만드는 천혜 스킬.",
      },
      {
        name: "유언비어",
        nameJp: "流言飛語",
        ...
        slMax: "상한 없음",
        condition: "씬 1회",
        effect: "〈페이즈：오그마〉로 취득 가능. 대상은 난이도〔10+SL〕의 〔지력〕 판정. 실패한 캐릭터에게 〔방심〕을 부여. 허언으로 대상을 속여 혼란시키는 천혜 스킬.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "사신에게 노림받은 자",
        text: "에린델에도 이성에게 인기 없는 인간은 있다. 그들이 품는 자조적인 관념으로 '우타르하에게 미움받고 있다'는 관용구가 있다. 자신이 사신 우타르하에게 점찍혀 이성을 가까이 하지 못하게 하는 것이라는, 일종의 자학 유머다. 이 속설의 원형은 그란펠덴을 거점으로 활동했다는 모험자 우르니히의 일화로, 그에게는 적어도 7번의 결혼 기회가 있었으나 우타르하의 방해로 7명의 약혼자가 잇달아 목숨을 잃었다. 결국 우르니히는 정화 의식으로 우타르하를 물리치는 데 성공했지만, 집착을 버리지 못한 우타르하가 그의 목숨을 마지막까지 노렸고, 결국 악마의 화살에 어이없이 쓰러지고 말았다.",
      },
      {
        heading: "파멸의 사랑 전도사",
        text: "우타르하는 연정이 많은 여신이라 불리며, 색욕을 관장하는 사신이다. 사람의 영혼에 매력적인 이성으로 나타나 인심을 혹하게 하고 파멸로 이끈다고 한다. 예로부터 우타르하가 세상을 어지럽힌 일화는 수없이 많다. 라인의 은행가 딸 사라는 우타르하와 계약해 얻은 독약으로 연적을 차례차례 죽인 죄로 처형되었으며, 세리아 대제국에서는 우타르하의 화신에 빠진 나머지 악정을 펼쳐 나라를 약화시킨 황제도 있다. 우타르하가 신봉하는 미약이나 연적의 불행을 빌어주는 예물이 지하 시장에 유통되고 있는 것도 사실이며, 이를 신전이 엄격히 금지하고 있다.",
      },
    ],
    skills: [
      {
        ...
        slMax: "1",
        condition: "방어 중 1회",
        effect: "〈페이즈：우타르하〉로 취득 가능. 대상에게 자신으로의 커버를 행하게 한다. 대상이 행동 연기를 행한다. 미행동 시에 커버를 행할 수 있으며 대상은 이 효과를 거부할 수 있다. 우타르하의 축복으로 대상에게 자신으로의 열정을 갖게 하는 천혜 스킬.",
      },
      {
        name: "열광의 입맞춤",
        nameJp: "熱狂の口づけ",
        ...
        slMax: "상한 없음",
        condition: "씬 1회",
        effect: "〈페이즈：우타르하〉로 취득 가능. 대상은 난이도〔10+SL〕의 〔정신〕 판정. 실패한 캐릭터에게 〔역상〕을 부여. 우타르하의 축복으로 대상에게 자신으로의 열정을 갖게 하는 천혜 스킬.",
      },
      {
        name: "약탈의 사랑",
        nameJp: "略奪の愛",
        ...
        cost: "—",
        slMax: "상한 없음",
        effect: "〈페이즈：우타르하〉로 취득 가능. 대상이 배드 스테이터스를 받고 있을 때 유효. 대상에게 〔SL×3〕점의 HP 로스와 MP 로스를 부여. 사랑을 빼앗아 생의 의지와 마음을 잃게 만드는 천혜 스킬.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "사신의 속삭임",
        text: "파리스 평원 남부, 하토파스 협곡 부근에 번성했던 레덴 왕국에서 '장골왕'이라 불리며 한 시대를 구축한 브레베크 왕이 있었다. 북방의 파리스 왕국에 대항해 세제 개혁을 단행하고 도시 공공시설의 수복으로 민심을 모아 국력을 키웠다. 그러나 브레베크 왕의 치세는 심복 쿠에트의 손에 의한 암살로 막을 내렸다. 쿠에트는 왕의 어린 시절부터의 형제나 다름없는 측근이었다. 재건된 극장 시찰 귀갓길에 갑자기 칼을 빼든 쿠에트에게 왕은 놀란 나머지 한 마디도 못하고 쓰러졌다. 이 갑작스러운 배신 뒤에는 사신의 책략이 있었다고 전해진다. 배신의 여신 리논의 개입 없이 이 반역을 설명할 수 있는 자는 현재도 없다.",
      },
      {
        heading: "배신의 사녀신",
        text: "배신의 여신 리논은 후드 달린 긴 옷을 두른 소녀의 모습으로 나타나는 소신이다. 그 모습은 겉으로 편안하고 밝은 분위기로 가득 차 있어 증거를 잡기 어렵다. 리논은 타인을 배신하게 하거나 누군가에게 누군가를 배신하게 만드는 것을 좋아하는 사신이다. 배신을 강요당한 자의 악정한 전복, 배신당한 자의 절망을 양분으로 삼는다. 특히 신에게 독실한 자들을 좋아해 성직자 앞에 자주 나타난다고 한다. 리논에게 힘을 부여받은 자는 그 생애의 끝에 반드시 호된 배신을 당해 쓰러진다고 전해진다.",
      },
    ],
    skills: [
      {
        ...
        slMax: "1",
        condition: "시나리오 1회",
        effect: "〈페이즈：리논〉으로 취득 가능. 자신이 공격 데미지를 받은 직후에 사용. 그 데미지로 받은 HP 데미지와 같은 양만큼 대상에게도 HP 로스를 부여(최대 최대HP). 자신에게 공격을 행하지 않은 캐릭터를 대상으로 선택해도 좋다. 적의 공격을 이용해 주변의 자에게도 같은 상처를 주는 천혜 스킬.",
      },
      {
        name: "절망의 미소",
        nameJp: "絶望の笑み",
        ...
        slMax: "1",
        condition: "시나리오 1회",
        effect: "〈페이즈：리논〉으로 취득 가능. 대상이 판정을 행한 직후에 한해 사용 가능. 그 판정에서 굴린 주사위 중 1개의 눈을 1로 변경. 모든 주사위가 1의 눈이 되면 펌블이 된다. 미소로 대상에게 절망을 주는 천혜 스킬.",
      },
      {
        name: "배신의 금화",
        nameJp: "背信の金貨",
        ...
        slMax: "1",
        condition: "씬 1회",
        effect: "〈페이즈：리논〉으로 취득 가능. 대상이 판정을 행한 직후에 사용. 그 판정을 다시 굴린다. 그 때 주사위 수는 변경되지 않는다. 또한 판정 후 대상은 100G를 취득한다. 저주받은 금화를 건네 배신의 마음을 불러일으키는 천혜 스킬.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "두려운 사신 교단",
        text: "에린델에서 암약하는 사신 교단 중에서도 가장 두렵다고 불리는 조직이 '잔학파'라 불리는 집단일지 모른다. 잔학의 신 스타르하를 신봉하는 이 교단의 신도들은, 사신의 총애를 받기 위해 잔학한 행위를 쌓는다. 신전에 방화하거나 지나치는 여행자를 집단으로 린치함으로써 교단 내 지위를 높인다. 그러나 한편으로 '침묵파'라 불리는 종파도 생겨났다. 이들은 잔학한 행위를 일절 하지 않고 스타르하에게 소외당하는 경지에 견뎌내는 것을 교의로 삼는다. 잔학한 것을 무엇보다 사랑한 끝에 '신의 사랑이 얻어지지 않는 것이야말로 진정으로 잔혹하지 않은가'라는 결론에 이른 이들로, 자신의 목숨을 노리는 자에 대한 반격조차 행하지 않고 견뎌내려 한다.",
      },
      {
        heading: "잔학의 사녀신",
        text: "스타르하는 낫 모양의 유연한 몸을 가진 거구의 여신으로, 온갖 무기를 다룬다고 한다. 성질은 잔인무도하며, 피와 고통의 쾌락을 무엇보다 즐긴다고 전해진다. 다양한 무술에 뛰어나 사악화한 요마에게 검·창·활 등을 가르치는 무술의 신이기도 하다. 때로는 신의 아이 앞에도 나타나 무술을 가르치고, 단련시킨 제자들을 스스로의 손으로 참살하는 것을 즐긴다고도 전해진다. 신성왕을 섬기는 마법사에게 납치된 공주를 구하러 스스로 마계에 내려갔을 때, 스타르하의 가르침을 받은 검의 달인과 격전을 벌였다는 전설이 전해진다.",
      },
    ],
    skills: [
      {
        ...
        slMax: "상한 없음",
        condition: "씬 1회",
        effect: "〈페이즈：스타르하〉로 취득 가능. 자신의 HP가 최대 HP 미만일 때 사용하는 행동 연기를 행한다. 자신이 행하는 캐릭터 하나만을 엔게이지시킬 수 있으며, 미행동 시에 커버를 행한다. 대상은 이 효과를 거부할 수 있다. 단독 결투에 특화된 전투 기술을 표현하는 천혜 스킬.",
      },
      {
        name: "혈람무쌍",
        nameJp: "血嵐無双",
        ...
        slMax: "상한 없음",
        condition: "씬 1회",
        effect: "〈페이즈：스타르하〉로 취득 가능. 대상에게 무기 공격을 행한다. 백병 공격이라면 사격 공격에도 행할 수 있으며, 사격 공격이라면 백병 공격에도 행할 수 있다. 자신과 엔게이지하고 있는 캐릭터를 대상으로 할 수 있다. 스타르하 직전의 기술로 그 자리의 모든 적을 한 번에 공격하는 천혜 스킬.",
      },
      {
        name: "잔학무비",
        nameJp: "残虐無比",
        ...
        slMax: "1",
        condition: "씬 1회",
        effect: "〈페이즈：스타르하〉로 취득 가능. 행하는 공격 대상에게 1점 이상의 HP 데미지를 입혔을 때 사용. 행하는 공격의 명중 판정에 +1D. 이 효과는 씬 종료까지 지속되며 3회까지 중복된다. 전투의 격렬함에 의해 고양되는 천혜 스킬.",
      },
    ],
  },
  {
    ...
    lore: [
      {
        heading: "영원의 기아",
        text: "신성왕에게 반기를 든 '고대의 민'들은 신성왕의 휘하 트르풀이 이끄는 군세를 골타 마을에 몰아붙였다. 수세에 몰린 '고대의 민'들은 성내의 파가스라는 기사에게 저주를 걸기로 했다. 원래 몸집이 크고 대식가였던 파가스는 이 저주로 사악화해, 먹어도 먹어도 배가 차지 않는 악귀로 변해버렸다. 마법 항아리가 아무리 식료를 만들어내도 파가스가 모두 먹어치웠고, 그것으로도 부족해 마침내 마법 항아리 자체를 입에 넣어 씹어 부수었다. 식료 공급 수단을 잃은 트르풀 군은 기아에 무릎을 꿇고 낙성을 허락했다. 승리한 '고대의 민'들이 파가스를 사신으로 추앙하려 했을 때 파가스는 이미 마계로 사라진 뒤였다. 여전히 배고픔을 억누르지 못한 파가스는 결국 자신의 몸을 먹기 시작해 스스로를 봉인해버렸다.",
      },
      {
        heading: "폭식의 사신",
        text: "사악한 소신 파가스는 폭식을 관장하는 사신이다. 귀에서 발꿈치까지 성인 7걸음 분, 눈과 눈 사이는 주먹 7개 분, 사슴 7마리를 한 번에 입에 넣을 정도의 거대한 악귀로 알려져 있다. 뭐든지 먹어치우는 악식가로 배부름을 모른다고 한다. 파가스는 무언가를 강렬히 갈망하는 자를 찾아내 사악한 축복을 부여한다. 사신에게 점찍힌 자는 갈망을 이루기 위한 힘을 부여받지만 결코 만족할 수 없게 된다. 목표는 다가갈수록 더욱 커지고, 마음에 허기를 가져다준다. 영원히 손이 닿지 않는 고통을 맛보며 이윽고 갈망자는 이성을 잃는다.",
      },
    ],
    skills: [
      {
        ...
        cost: "—",
        slMax: "1",
        effect: "〈페이즈：파가스〉로 취득 가능. 대상과 〔근력〕으로 대결을 행한다. 대결에 승리한 경우, 대상이 소지한 〔종별：식량〕〔종별：요리〕 아이템을 하나 잃는다. 어느 아이템을 잃는지는 GM이 무작위로 결정. 대상이 해당 아이템을 소지하지 않은 경우 효과는 없다.",
      },
      {
        name: "괴력광란",
        nameJp: "怪力狂乱",
        ...
        cost: "—",
        slMax: "상한 없음",
        effect: "〈페이즈：파가스〉로 취득 가능. 〔맹전사화(SL)〕를 받는다. 파가스의 저주로 괴력을 발휘하는 천혜 스킬. 동시에 채워지지 않는 굶주림이 자신을 저주한다.",
      },
      {
        name: "무한의 갈망",
        nameJp: "無限の渇望",
        ...
        cost: "—",
        slMax: "상한 없음",
        effect: "〈페이즈：파가스〉로 취득 가능. 데미지 증가를 행한다. 무기 공격으로 대상에게 1점 이상의 HP 데미지를 입힌 경우, 행하는 공격의 데미지에 +〔SL×5〕 회복한다. 이 효과는 씬 종료까지 지속. 공격과 동시에 대상의 힘을 빼앗는 천혜 스킬.",
      },
    ],
  },
]

function EvilGodsSection() {
  return (
    <section>
      <div style={{ borderBottom: `2px solid #B83060`, paddingBottom: 16, marginBottom: 28 }}>
        <h2 style={{ margin: 0, fontSize: 28, color: "#F0E8C8", fontFamily: "'Noto Serif KR', serif" }}>
          사신 <span style={{ fontSize: 16, color: "#8A7830", fontWeight: 400 }}>邪神</span>
        </h2>
        <p style={{ margin: "10px 0 0", color: "#B0A060", fontSize: 13 }}>
          선한 존재인 신들과 대비되는 악한 존재, 사신. 에린에서 그 이름은 널리 알려져 있으나, 사신에 관한 지식과 전승은 거의 남아 있지 않다.
        </p>
      </div>

      <div style={{ display: "flex", gap: 28, marginBottom: 36, alignItems: "flex-start" }}>
        <div style={{ flex: 1 }}>
          <Prose text="사신은 엘다들이 세계를 관리하기 위해 창조한 존재로, 겉모습은 신들과 다를 바 없다. 그러나 외모와 달리 사신들의 정신은 추악하고 소름끼치는 치유기로 가득 차 있다. 에린델 각지의 마계 혹은 별도의 장소에 봉인되어 있는 것으로 알려진다." color="#C8B870" />
          <Prose text="에린 내에서 사신을 신봉하는 자가 드물지 않다. 그중에는 '사신 교단' 혹은 '竜의 颚門'으로 불리는 암살자 집단처럼 조직화된 신봉자들도 존재한다. 사신에 관한 더 자세한 정보는 PW가이드를 참고할 것." color="#C8B870" />
        </div>
        <div style={{ width: 320, flexShrink: 0, border: `2px solid #B83060`, borderRadius: 10, overflow: "hidden", background: "#0C0A06" }}>
          <img
            src="/evil-gods/evil-gods.jpg"
            alt="사신 일람"
            style={{ width: "100%", display: "block" }}
            onError={(e) => {
              const img = e.currentTarget as HTMLImageElement
              ...
              if (wrapper) {
                wrapper.style.display = "flex"; wrapper.style.flexDirection = "column"
                wrapper.style.alignItems = "center"; wrapper.style.justifyContent = "center"
                wrapper.style.height = "280px"; wrapper.style.color = "#B83060"
                wrapper.style.gap = "8px"; wrapper.style.fontSize = "13px"
                wrapper.innerHTML = `<span style="font-size:40px">🖼</span><span>사신 일람</span><span style="color:#5A2830;font-size:11px">/evil-gods/evil-gods.jpg</span>`
              }
            }}
          />
        </div>
      ...
      {evilGods.map((m, idx) => (
        <div key={m.id} style={{ marginBottom: idx < evilGods.length - 1 ? 52 : 0 }}>
          <div style={{ background: `linear-gradient(135deg, #0A0808 0%, ${m.accent}1A 100%)`, border: `1px solid ${m.accent}`, borderRadius: 8, padding: "14px 20px", marginBottom: 20, display: "flex", alignItems: "center", gap: 12 }}>
            <span style={{ background: m.accent, color: "#0A0808", fontSize: 11, fontWeight: 700, padding: "2px 8px", borderRadius: 4, flexShrink: 0 }}>{m.title}</span>
            <h3 style={{ margin: 0, fontSize: 22, color: m.accent, fontFamily: "'Noto Serif KR', serif" }}>{m.name}</h3>
            <span style={{ color: "#6A5820", fontSize: 13, marginLeft: 2 }}>{m.nameJp}</span>
          </div>
          <div style={{ marginBottom: 20 }}>
            {m.lore.map((section, i) => (
              <div key={i} style={{ marginBottom: i < m.lore.length - 1 ? 18 : 0 }}>
                <div style={{ color: m.accent, fontWeight: 700, fontSize: 14, borderLeft: `3px solid ${m.accent}`, paddingLeft: 10, marginBottom: 8 }}>{section.heading}</div>
                <p style={{ margin: 0, color: "#C8B870", fontSize: 13, lineHeight: 1.85 }}>{section.text}</p>
              </div>
            ))}
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 }}>
            {m.skills.map((skill, si) => <SkillCard key={si} skill={skill} accent={m.accent} />)}
          </div>
          {idx < evilGods.length - 1 && <div style={{ borderTop: "1px solid #2A2810", marginTop: 44 }} />}
        </div>
      ))}
    </section>
  )
...
export default function MythologyPage() {
  ...
  function renderContent() {
    switch (active) {
      ...
      case "evilgods":   return <EvilGodsSection />
      default:
