...
const CLASSES: Category[] = [
  { id: 'warrior', name: '워리어', accent: '#C0503A', skills: [
    ...
    { id: 'war-hate-control',     name: '헤이트 컨트롤',   tier: 'special' },
    { id: 'war-bodybuilding',     name: '보디빌딩',        tier: 'special' },
  ] },
  { id: 'acolyte', name: '어콜라이트', accent: '#C8A030', skills: [
    ...
    { id: 'acl-prayer-word',      name: '플레이어 워드',    tier: 'special' },
    { id: 'acl-medic',            name: '메딕',             tier: 'special' },
  ] },
  { id: 'mage', name: '메이지', accent: '#5A6ABE', skills: [
    ...
    { id: 'mag-technology',       name: '테크놀리지',         tier: 'special' },
    { id: 'mag-metamorphose',     name: '메타모르포제',       tier: 'special' },
  ] },
  { id: 'thief', name: '시프', accent: '#4A7A6A', skills: [
    ...
    { id: 'thf-cracker',           name: '크래커',             tier: 'special' },
    { id: 'thf-look-out',          name: '룩 아웃',            tier: 'special' },
  ] },
]
