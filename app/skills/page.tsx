...
const CLASSES: Category[] = [
  ...
  { id: 'priest', name: '프리스트(상급)', accent: '#8A60C0', skills: [
    { id: 'pst-divine-force',      name: '디바인 포스',         tier: 'normal' },
    { id: 'pst-devotion',          name: '디보션',              tier: 'normal' },
    { id: 'pst-light-burst',       name: '라이트 버스트',       tier: 'normal' },
    { id: 'pst-reduce',            name: '리듀스',              tier: 'normal' },
    { id: 'pst-mantelet',          name: '맨텔렛',              tier: 'normal' },
    { id: 'pst-mental-link',       name: '멘탈 링크',           tier: 'normal' },
    { id: 'pst-break-evil',        name: '브레이크 이블',       tier: 'normal' },
    { id: 'pst-visitation',        name: '비지테이션',          tier: 'normal' },
    { id: 'pst-saint-blessing',    name: '세인트 블레싱',       tier: 'normal' },
    { id: 'pst-spiritual-weapon',  name: '스피리츄얼 웨폰',     tier: 'normal' },
    { id: 'pst-silli',             name: '실리',                tier: 'normal' },
    { id: 'pst-erase-magic',       name: '이레이즈 매직',       tier: 'normal' },
    { id: 'pst-cure-all',          name: '큐어 올',             tier: 'normal' },
    { id: 'pst-transcend',         name: '트랜센트',            tier: 'normal' },
    { id: 'pst-treatforce',        name: '트리트포스',          tier: 'normal' },
    { id: 'pst-parifeytier',       name: '패리페이티어',        tier: 'normal' },
    { id: 'pst-patronize',         name: '패트로나이즈',        tier: 'normal' },
    { id: 'pst-post-haste',        name: '포스트 헤이스트',     tier: 'normal' },
    { id: 'pst-prepared',          name: '프리페어드',          tier: 'normal' },
    { id: 'pst-flipflop',          name: '플립플록',            tier: 'normal' },
    { id: 'pst-high-protection',   name: '하이 프로텍션',       tier: 'normal' },
    { id: 'pst-holy-assist',       name: '홀리 어시스트',       tier: 'normal' },
    { id: 'pst-heal-rise',         name: '힐 라이즈',           tier: 'normal' },
    { id: 'pst-heal-all',          name: '힐 올',               tier: 'normal' },
    { id: 'pst-divine-light',      name: '디바인 라이트',       tier: 'normal' },
    { id: 'pst-wrath',             name: '라스',                tier: 'normal' },
    { id: 'pst-reviver',           name: '리바이버',            tier: 'normal' },
    { id: 'pst-barrier',           name: '배리어',              tier: 'normal' },
    { id: 'pst-cast-force',        name: '캐스트 포스',         tier: 'normal' },
    { id: 'pst-hollow-light',      name: '홀로우 라이트',       tier: 'normal' },
  ] },
