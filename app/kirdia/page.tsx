...
function RelationsSection() {
  const relations = [
    { name: "에루란 왕국",       content: "무한의 사막을 사이에 두고 있어 직접 접경하지 않는다. 기본적으로 중립적인 관계를 유지하며, 교역로를 통한 경제적 교류가 주를 이룬다." },
    { name: "신성 반즈탄 제국", content: "제국의 동방 진출 루트 상에 위치하기 때문에 미묘한 관계에 있다. 사막이 천연 방벽 역할을 하므로 직접 충돌보다는 외교적 교섭이 중심이다." },
    { name: "파리스 동맹",       content: "반즈탄 제국에 대항하는 공통 이해관계를 가지고 있어 우호적인 관계에 있다. 공화국의 독자 노선 덕분에 동맹에 직접 가입하지 않으면서도 협력 관계를 유지한다." },
  ];
  return (
    <div>
