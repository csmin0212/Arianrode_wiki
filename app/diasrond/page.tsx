...
function StructureSection() {
  const towers = [
    ...
    { name: "제2탑 — 다그데스 탑",     note: "천공신 다그데모라에게 봉헌된 탑. 신성 기사단 본부가 설치되어 있다." },
    ...
    { name: "제6탑 — 그란아인 탑",     note: "뇌신 그란아인에게 봉헌된 탑. \"긴 발톱\" 집행부 시설이 있으며 비공개 구역이 많다." },
  ];
  return (
    <div>
...
function FaithSection() {
  const gods = [
    { name: "다그데모라", role: "천공신", domain: "하늘, 바람, 지배" },
    ...
    { name: "그란아인",   role: "뇌신",        domain: "번개, 전쟁, 힘" },
...
function OrgsSection() {
  const orgs = [
    ...
    },
    {
      name: "긴 발톱 (라봐르다)",
      role: "성도 집행 기관",
      content: "교황청 직속의 비밀 집행 기관. 신앙의 적이나 이단, 내부 반역자를 색출하고 처단하는 역할을 맡는다. 제6탑(그란아인 탑)에 시설을 두며, 일반 신관들조차 그 구성원과 활동을 정확히 알지 못한다. \"긴 발톱\"이라는 이름은 보이지 않는 곳에서 신속하게 대상을 낚아채는 것에서 유래했다.",
    },
    {
      name: "마제스타 신전",
      role: "성도 연계 신전",
