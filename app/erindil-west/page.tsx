...
const nations: Nation[] = [
  ...
  },
  {
    ...
    founded: "성력 719년 (번스터 제국)", capital: "피지아스 섬", government: "제정",
    summary: "서쪽 바다의 피지아스 섬을 거점으로 하는 제국. 성력 999년에 신성 번스터 제국으로 개칭하고 동방 진출을 노리며 에를랑 왕국 등과 긴장 관계에 있다. 최근 다시 개전을 준비하고 있다는 소문이 돌아 긴장이 고조되고 있다.",
    href: "/vanstar", icon: "⚔️",
  },
  {
    name: "파리스 동맹",
    ...
    summary: "신성 번스터 제국의 침략에 대항하기 위해 성립된 국가 연합. 에린디르 서방 중원의 도시 국가들로 구성된다. 북방에서 마족의 대침공을 받은 이후, 동맹의 결속과 방위 강화가 과제가 되고 있다.",
