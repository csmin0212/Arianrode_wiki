...
const nations: Nation[] = [
  ...
  },
  {
    ...
    founded: "성력 719년 (반즈탄 제국)", capital: "핀지아스 섬", government: "제정",
    summary: "서쪽 바다의 핀지아스 섬을 거점으로 하는 제국. 성력 999년에 신성 반즈탄 제국으로 개칭하고 동방 진출을 노리며 에를랑 왕국 등과 긴장 관계에 있다. 최근 다시 개전을 준비하고 있다는 소문이 돌아 긴장이 고조되고 있다.",
    href: "/vanstar", icon: "⚔️",
  },
  {
    name: "파리스 동맹",
