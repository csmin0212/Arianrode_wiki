...
const nations: Nation[] = [
  {
    ...
    founded: "성력 300년경", capital: "왕도 프로글레스", government: "왕정",
  ...
  },
  {
    ...
    founded: "성력 719년 (반즈탄 제국)", capital: "피지아스 섬", government: "제정",
    summary: "서쪽 바다의 피지아스 섬을 거점으로 하는 제국. 성력 999년에 신성 반즈탄 제국으로 개칭하고 동방 진출을 노리며 에루란 왕국 등과 긴장 관계에 있다. 최근 다시 개전을 준비하고 있다는 소문이 돌아 긴장이 고조되고 있다.",
    href: "/vanstar", icon: "⚔️",
  },
  {
    name: "파리스 동맹",
...
function OverviewSection() {
  return (
    <div>
      ...
      <Prose text={"현재는 신성 반즈탄 제국, 에루란 왕국, 파리스 동맹, 키르디아 공화국의 4국 세력이 크다. 성력 1002년 파리스 동맹 성립 이후 국가 간의 큰 싸움은 거의 일어나지 않고 있지만, 현재도 많은 국가 간 경계선 부근에서 마찰이 빈번히 일어나며 다양한 교섭이 이루어지고 있다.\n\n더욱이 북방에서 마족의 대규모 침략을 받은 파리스 동맹은 가까스로 쫓겨난 상태이며, 이를 계기로 신성 반즈탄 제국이 다시 개전을 준비하고 있다는 소문도 있어 예단을 허용하지 않는 상황이다."} />
    </div>
  );
}
