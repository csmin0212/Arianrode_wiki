...
const orgs: Org[] = [
  {
    ...
    base: "은령성, 원탁의 방",
    leader: "루파스·라케슈",
    content: "국왕의 명령에 따르는 것을 대의로 하는 기사단. 단장 포함 3명의 간부는 비상시 에린디르에서도 손꼽히는 전투력을 가진 자들이라 전해진다. 단장 루파스는 국왕 수행 임무를 맡아, 현재 신성 반즈탄 제국에 대한 국경 경비에도 신경을 기울이고 있다.",
  },
  {
    name: "적지의 기사단",
    type: "군사 조직",
