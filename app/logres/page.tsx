...
const orgs: Org[] = [
  {
    ...
    base: "은령성, 원탁의 방",
    leader: "루파스·라케슈",
    content: "국왕의 명령에 따르는 것을 대의로 하는 기사단. 단장 포함 3명의 간부는 비상시 에린딜에서도 손꼽히는 전투력을 가진 자들이라 전해진다. 단장 루파스는 국왕 수행 임무를 맡아, 현재 신성 번스터 제국에 대한 국경 경비에도 신경을 기울이고 있다.",
  },
  {
    name: "적지의 기사단",
    type: "군사 조직",
    base: "적지의 관",
    leader: "루시디티·윈슬렛",
    content: "에를랑 왕국의 상설군. 단장을 맡는 것은 대대로 윈슬렛 가의 장녀. 대를 거듭해 출전해 온 윈슬렛 가의 루시디티를 '적지의 벗'이라 부르는 목소리는 높고, 그녀를 섬기는 기사단의 사기 또한 높다. 현재는 신성 번스터 제국에 대한 국경 경비 및 왕도 수비를 맡고 있다.",
  },
  {
    name: "야미구미 (闇組)",
    type: "사병 조직",
