...
function OverviewSection() {
  return (
    <div>
      ...
      <Prose text={"아스란은 타에 고립된 세계로, 신에게 이끌려 온 자 이외에는 다가설 수 없는 지역이다. 「검의 여신」 그로비스라는 소신과 「부패의 신」 세르노그라는 사신이 강림하고 있다."} />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginTop: 8, marginBottom: 20 }}>
        ...
        <div style={{ background: "#fff", border: "1px solid #E8E3DA", borderRadius: 10, padding: "16px 18px", borderLeft: `4px solid #2A5A3A` }}>
          <div style={{ fontFamily: "'Noto Serif KR', serif", fontSize: "13px", fontWeight: 700, color: "#2a2a2a", marginBottom: 8 }}>남부 (그로비스 영역)</div>
          <div style={{ fontSize: "13px", lineHeight: 1.8, color: "#555" }}>그로비스의 영역. 평원이나 구릉, 호수와 숲이 형성되는 밝고 온화한 땅. 「바람의 시대」 이전부터 이 땅에 오던 여러 종족이 아직도 많이 생존하고 있다.</div>
        </div>
      </div>
      <SecTitle title="아스란의 종족" />
      <Prose text={"아스란은 에린딜이나 알디온에 비해 휴린과 엘다난의 비율이 적고, 바르나·도앙·네바프·필볼의 수가 많다. 또한 그로비스에게 의지하는 정령수, 그로비스 영역의 정령이나 용 등의 생물이 인간 사회와 섞여 살고 있다는 것이 도시에서도 특징적이다."} />
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <div style={{ background: "#fff", border: "1px solid #E8E3DA", borderRadius: 10, padding: "16px 18px", margin: "8px 0 16px", borderLeft: `4px solid ${ACCENT}` }}>
        <div style={{ fontFamily: "'Noto Serif KR', serif", fontSize: "14px", fontWeight: 700, color: "#2a2a2a", marginBottom: 8 }}>그로비스와 세르노그</div>
        <div style={{ fontSize: "13px", lineHeight: 1.8, color: "#555" }}>그로비스와 세르노그는 아스란의 땅을 둘로 나눴다. 아스란 남반부가 그로비스의 진지, 북반부가 세르노그의 진지였다. 진지의 경계를 정하기 위해, 아스란 중앙에는 깊은 협곡이 생겨났다. 그로비스는 수정의 다리를 걸쳐 적지를 공격하는 준비를 하고, 세르노그는 뼈의 다리를 걸쳐 적지를 넘었다. 두 다리 사이에, 어느 쪽의 영역도 아닌 중립 지대가 존재한다.</div>
      </div>
      <SecTitle title="대리 전사들" />
      <Prose text={"아스란에서는 세르노그 편의 마물들과 싸우는 것이, 그로비스 배하에 있는 인간들이다. 그로비스의 전사 중에는, 타 세계에서는 볼 수 없는 특수한 능력을 가진 전사들도 포함되어 있다."} />
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 8 }}>
        <div style={{ background: "#fff", border: "1px solid #E8E3DA", borderRadius: 10, padding: "14px 16px" }}>
          ...
          <div style={{ fontSize: "12px", lineHeight: 1.7, color: "#666" }}>그로비스의 가호를 받아 싸우는 전사. 신성한 무기——신구를 소환하여 일시적으로 사용할 수 있다.</div>
        </div>
        <div style={{ background: "#fff", border: "1px solid #E8E3DA", borderRadius: 10, padding: "14px 16px" }}>
          <div style={{ fontFamily: "'Noto Serif KR', serif", fontSize: "13px", fontWeight: 700, marginBottom: 6, color: "#2a2a2a" }}>루이네이터</div>
          <div style={{ fontSize: "12px", lineHeight: 1.7, color: "#666" }}>일시적으로 사악화하였거나, 혹은 사악화하지 않고 그로비스의 의지로 사악함에서 되돌아온 자. 신체에 깃든 기운을 힘으로 바꾸는 것이 가능하다.</div>
        </div>
      </div>
      <SecTitle title="아스란의 전쟁" />
      <Prose text={"그로비스와 세르노그는, 아스란의 땅을 둘로 나눠 갖고 있었다. 아스란 남반부는 그로비스의 진지로 북반부는 세르노그의 진지였다. 진지의 경계를 정하기 위해, 아스란 중앙에는 깊은 협곡이 생겨났다. 그로비스는 자신의 혈전으로 아스란을 새빨갛게 물들이기까지 싸우겠다고 고함을 질렀고, 세르노그는 두 진지의 사이를 세상 끝으로 가득한 안개가 다할 때까지 무너뜨릴 것이라고 목소리를 높였다."} />
      <Prose text={"그들은 서로 자신의 배하가 되는 봉신들을 낳아, 서로 영역을 주고받는다. 이윽고 세계에는 「바람의 청청」이 일어나, 두 기둥의 신들만은 아스란에 남겨진 채 마물들은 마계로 추방됐다. 마물들은 그로비스 편의 전장 대부분에서, 인간에 의해 사악화하게 되는 자들이 전투로 인해 늘어나면서 전쟁은 마계와 가까운 경계선 전투로 변해 갔다."} />
      <SecTitle title="구명장 (九冥将)" />
      <Prose text={"세르노그를 섬기는 마물과 싸우는 것이, 그로비스 배하의 인간들이다. 세르노그 세력에서 조직적으로 그로비스 세력에 대항하기 위해, 세르노그의 총 9명의 무장——구명장이 존재한다. 그 리더적인 존재는 「지배자」 에크·카지슈, 「어둠의 전멸자」 키신, 「불의 격자」 카·아치, 「귀의 전멸자」 라고스타 등이 알려져 있다."} />
    </div>
  );
}
...
function CurrentSection() {
  return (
    <div>
      ...
      <Prose text={"아스란에서는 현재도 여신과 사신의 전쟁이 이어지고 있다. 두 신은 「바람의 시대」부터 이 아스란에서 싸워왔으며, 그 국경선은 지금도 변함없다. 각각의 영주에게는, 배하가 되는 인간이나 혹은 마물의 도시나 요새가 존재한다. 아스란의 거주자 대부분은, 그로비스 또는 세르노그에게 이끌리거나, 다른 세계에서 이끌려 온 자의 자손이다."} />
      <SecTitle title="그로비스 령" />
      <Prose text={"아스란의 남반부를 차지하는 그로비스 령은, 「검의 여신」이라 불리는 그로비스의 영향으로, 평원이나 구릉, 호수와 숲이 형성되는 생기 있는 대지다. 「바람의 시대」 이전부터 이 땅에 오던 여러 종족이 아직도 많이 생존하고 있다. 그 때문에 에린딜이나 알디온에 비해 휴린과 엘다난의 비율은 적고, 바르나·도앙·네바프·필볼의 수가 많다. 또한 그로비스에게 의지하는 정령수나 정령, 용 등의 생물이 인간 사회에 섞여 살고 있는 것이 도시에서 특징적이다."} />
      <SecTitle title="그로비스의 전력" />
      <Prose text={"아스란에 초대받은 인간은, 기본적으로 마대 세력과 싸우는 전사다. 그중에서도 특수한 것은 사로게트라 불리는 전사들로, 그로비스의 신성한 무기를 사용하는 자들이다. 루이네이터라 불리는 사악화에서 돌아온 자들도 포함되며, 이를 제외한 다른 종족, 워리어나 마이즈나 메이지 등이 없는 것은 아니다. 오히려 아스란에서는 그 과반수를 인간이 차지하고, 인간 사회가 크게 늘어나 있다. 도시를 형성하는 일반 시민들은, 상업에 관계하는 인간들보다는 의식이나 식료품의 생산에 관계하는 자들이 많이 모여 있어, 전원 다수가 생활 기반을 유지하기 위한 비전투원의 비율이 늘어나고 있다."} />
      <SecTitle title="그로비스의 도" />
      <Prose text={"그로비스 령에는 평원이나 구릉, 호수와 숲의 곳곳에 마을이나 촌락이 형성되어 있다. 그 중에서도 큰 도시는 「홍련신전」 엘카라도르와 그 주변에 생겨난 도시다. 「홍련신전」은 그로비스가 거처를 두는 대신전이며, 엘카라도르는 수도 기능을 담당한다."} />
      ...
      <Prose text={"마물들은, 과거 인간이 지녔던 영성을 보유하기 때문에, 원시적이면서도 집단 사회를 형성하는 경우가 많다. 더불어 그로비스 령의 전력에 대항하기 위해, 세르노그의 총 아래 조직적인 군사 형태를 형성하고 있다. 그 리더적 존재는 9명의 무장——구명장이 있다. 또한 마물이나 사악화한 집단에 의한 군단도 구성되어 있다."} />
      ...
      <Prose text={"세계를 파괴할 수 있는 3가지 신구가 있다. 어딘가에 그 이름과 물어의 결을 맺은 에르다의 하나인 것이 이 중의 하나의 신구를 소환했다. 그로비스와 싸우겠다고 맹세한 에르다를 두려워한 에르고의 전사들은, 이 3개의 신구의 소환에 관련하는 기술을 아는 자를 찾아 보고 있으나, 아스란 전역에서 빈틈없이 소문이 퍼져있는 것이 믿어지지 않는다고 한다."} />
    </div>
  );
}
...
function ElcaradorSection() {
  const districts = [
    { name: "클라나프라냐 (紅蓮神殿)", desc: "구릉 위에 건설된 신전과 그 주변 일대를 가리키는 지역. 그로비스가 사는 신사이며, 원로원이 설치되는 정치적 중심지이기도 하다. 또한 전사를 모집하는 거점이 되고 있으며, 신관들이 거처하는 종교적 성지이기도 하다. 그 경내는 하나의 구가라고 말해도 좋을 정도의 넓이를 자랑한다." },
    { name: "피에르비 층구", desc: "구릉 앞쪽을 따라 펼쳐지는 상업 구역. 많은 단조 공방이 모이는 공업 지대가 되고 있다. 검을 두들기고 불을 치는 그로비스를 신앙하는 아스란의 민들에게는, 단조 공방은 신성한 직업으로 여겨지고 있다. 그 때문에 신사 가장 가까운 중심부에 단조 공방이 집중하고 있다." },
  ...
  const orgs = [
    { name: "엘카라도르의 원로원", type: "정부 조직", base: "클라나프라냐", leader: "「회안의」 브라드렌 (의장)", content: "그로비스의 영광의 나라를 운영하기 위한 원로원. GM이 설정하거나 PC가 어드벤처의 의뢰나 명령을 받아 조직과 연결되게 된다. 여기에 소개된 조직은, PC가 코넥션으로 취득할 수 있다. 도시 선거에 의해 선출된 88인의 의원이, 도시 운영에 관련되는 것을 합의해 결정한다. 의장에 선출되는 것은 도시의 공적을 올린 공헌자가 된다." },
    { name: "십삼신장", type: "군사 조직", base: "클라나프라냐", leader: "「유신장」 클라스나야 (필두)", content: "그로비스의 직속 정예 전사들. 아스란에서 싸우는 용맹한 전사들의 조직으로, 전장을 비롯해 각지의 다양한 장면에서 활약하고 있다. 勇·仁·義·礼·智·信·忠·孝·道·愛·節·敬을 아우르는 13가지 덕목의 이름을 각 시대에서 가장 유력한 자가 명칭으로 불린다." },
    { name: "이스트리비테리", type: "군사 조직", base: "클라나프라냐", leader: "십삼신장", content: "아스란에서 그로비스를 섬기는 전사들의 조직. 아스란의 모든 장소가 전쟁터라는 것이 기본적 전제로, 전사들은 언제나 세르노그의 마물들과 싸울 준비를 하고 있다. 큰 전투 행동이 일어나는 경우에는, 신전에서 군집이 이루어진다." },
  ...
  return (
    <div>
      ...
      <Prose text={"아스란의 남부에 있는 인간들의 도시. 「검의 여신」 그로비스가 거처하는 땅으로, 그로비스 령의 수도로 여겨지고 있다. 도시는 아스란 남부의 작은 구릉 위에 건설되어 있다."} />
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: 10, marginTop: 8, marginBottom: 20 }}>
        {[
          ...
          { label: "수호신", value: "그로비스 (守護神)" },
          { label: "종교", value: "그로비스 신앙·칠대신선 신앙" },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14, marginTop: 8, marginBottom: 20 }}>
        {[
          { name: "클라나프라냐", jp: "クラナプラーニャ", desc: "엘카라도르의 상징이자 신의 신전. 홍련신전이라 불린다. 아스란이 만들어진 때 그로비스가 최초에 위치를 정한 성지로, 그 현재는 종교적 성지인 동시에 지배자의 자리가 되는 신전이기도 하다. 세계와 아스란을 이어주는 관문도 신전 내에 있어, 아스란에 초대된 인간들은 이 곳에 도착하게 된다." },
...
function ZanSection() {
  const orgs = [
    ...
    { name: "부·스베다", type: "지하 조직", base: "불명", leader: "레프·슈체바른", content: "잔·덴·바루아에 노동력으로 끌려온 인간들이 비밀리에 결성하는 레지스탕스 조직. 노예 해방을 목표로 하여, 그로비스 령의 도시들과 연락을 취하고 있다. 지하 활동을 추진하며 「언젠가 자유의 땅을」을 합언으로 삼고 있다." },
  ];
  return (
    <div>
...
function PeopleSection() {
  const people = [
    ...
    },
    {
      ...
      note: "그로비스 령 내의 범죄자나 위험 인물을 수용하는 시설 시발바르의 수문장. 특히 사악화한 자를 봉인해 두는 지하층 입구를 관리하고 있다. 무사에게도 능숙한 성격으로 묵묵히 일을 해낸다. 해방 루이네이터를 결정하는 것도 그의 일이 된다.",
    },
    {
      name: "이슈·카크",
      nameJp: "イシュ・カック",
      ...
      note: "엘카라도르의 공방에서 신구를 비롯해 다양한 도구를 제작하는 단조 공인. 아득히 먼 고대부터 엘카라도르에 존재했다는 화대 정령으로 여성형이다. 그로비스로부터 이름을 부여받았다. 공방을 방문하는 자에게 여러 도움이 되는 조언도 해 준다.",
    },
    {
      ...
      note: "내관자. 많은 세계들에 찾아온 자들에게 「별의 문」을 통해 에린에 이끈 자. 사고에 의해 발키리의 몸에 옮겨갔다. 「별의 문」을 쓰러뜨린 후에는 에린에 남아, 「검의 여신」 그로비스의 곁에서 에린에 끊임없이 오는 모험자들과 싸움을 이어가고 있다.",
    },
  ];
  return (
    <div>
      <Prose text={"엘카라도르를 거점으로 활동하는 주요 인물들. 「검의 여신」 그로비스와 그 봉사자들을 중심으로, 아스란의 운명을 담당하는 자들이다."} />
