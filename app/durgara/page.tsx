...
const durgStats = {
  ...
  raceComposition: [
    { race: "히유린",   pct: 78, color: "#2A5F9E" },
    { race: "두앙",     pct: 9,  color: "#8B2D2D" },
    { race: "엘다나안", pct: 8,  color: "#1A6B4A" },
...
const durgHistory = `두르가라는 핀지아스 섬과 에린디르 본토 대륙 사이에 떠 있는 고립 섬(孤島)의 도시이다. 바이킹(*) 의 거점으로 발달했던 유서 깊은 집락이 그 기원이며, "해상의 도시"라 부르는 이도 있다.

(*) 에린디르에서의 바이킹은 배의 보유에 능하고, 교역과 용병, 약탈 등 돈벌이를 생업으로 삼는 자들을 가리킨다. 그들은 항해와 전투 기술을 대대로 전하며 바다를 누빈다.
