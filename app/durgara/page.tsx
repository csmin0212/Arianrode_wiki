...
const durgFacilities: Facility[] = [
  ...
  {
    name: "두르가라 신전",
    content: "두르가라가 자랑하는 거대한 신전. 항구를 내려다볼 수 있는 언덕 위에 세워진다. 이 신전에 아에마 신전, 서쪽에 그랑아인 신전, 동쪽에 고바논 신전이 나란히 위치하는 3개의 신전 광장이 있어, 시민들에게 열린 대정원이기도 하다. 관광 명소이며, 다양한 거래 창구와 모험자를 위한 의뢰 창구도 갖추고 있다. 신관장은 필보르족의 멜노스이다.",
  },
  {
    name: "칼간 조선소",
