...
const hammervilleStats = {
  population: "약 5,000명",
  raceComposition: [
    { race: "히유린",   pct: 70, color: "#2A5F9E" },
    { race: "엘다나안", pct: 15, color: "#1A6B4A" },
...
파리스 동맹에 속하는 도시 중에서는 가장 작은 편에 속하지만, 여기서 만들어지는 무기와 방구의 질은 에린디르 서방 전체에서도 최고 수준으로 인정받는다. 특히 암즈 크리스탈을 금속에 합성하는 기술은 하마르빌만의 전매특허로, 이를 목적으로 먼 거리를 마다않고 찾아오는 모험자와 귀족도 적지 않다.`;

const hammervilleCurrentStatus = `도시 통치는 대장간 조합이 합의제 방식으로 이끌고 있다. 가장 뛰어난 장인이 조합장을 맡는 전통이 있으며, 현재는 엘다나안 노장 마곤로가 그 자리를 맡고 있다.
...
const hammervilleOrganizations: Org[] = [
  {
    ...
    base: "대장간 조합 회관",
    leader: "마곤로",
    content: "하마르빌의 모든 대장장이와 금속 공예 직인이 소속된 조합이자 도시 통치 기관. 가장 뛰어난 장인이 조합장을 맡는 전통이 있으며, 현 조합장 마곤로는 수백 년을 살아온 엘다나안 노장이다. 조합은 기술 전수, 품질 관리, 의뢰 중개, 도시 행정을 모두 담당한다.",
  },
  {
    name: "십금추 (十金槌)",
    type: "명예 칭호 보유자 집단",
...
const hammervilleCharacters: Character[] = [
  {
    ...
    race: "엘다나안", gender: "남", age: "수백",
    hairColor: "흰", eyeColor: "은색", skinColor: "흰",
    title: "대장간 조합장",
    content: "하마르빌 대장간 조합의 조합장을 맡고 있는 엘다나안 노장. 긴 세월 동안 무수히 많은 무기를 만들어 왔으며, 암즈 크리스탈 합성 기술을 이 도시에 뿌리내린 장본인이기도 하다. 말수가 적고 작업에만 집중하는 성격이지만, 재능 있는 젊은 장인을 발굴하는 눈을 가지고 있다.",
  },
  {
    name: "ネリア",
    nameKo: "넬리아",
    quote: "어서오세요! 어떤 무기가 필요하신가요?",
    race: "히유린", gender: "여", age: "24",
    hairColor: "적갈색", eyeColor: "갈색", skinColor: "흰",
    title: "대장간 조합 접수 담당",
    content: "대장간 조합 회관의 접수를 담당하는 히유린 여성. 밝고 활달한 성격으로 방문자들에게 인기가 높다. 무기 지식도 상당하여 고객의 필요에 맞는 무기를 적절히 추천하는 능력이 뛰어나다. 조합장 마곤로에게도 신뢰받고 있어, 접수 이외의 각종 잡무도 폭넓게 담당하고 있다.",
  },
  {
    name: "クレイグ・ハマー",
    nameKo: "크레이그·해머",
    quote: "십금추에 뽑히는 날까지 절대 멈추지 않는다",
    race: "히유린", gender: "남", age: "31",
...
function HammervilleSection() {
  return (
    <div>
      ...
      <Prose text={"하마르빌 특유의 기술인 암즈 크리스탈 합성은, 특수한 마력을 지닌 크리스탈을 무기나 방구에 융합시키는 연금 기술이다. 이 기술로 만들어진 무기는 통상 무기보다 훨씬 강력하며, 에린디르 서방 전체에서 수요가 높다.\n\n기술 습득에는 수년의 수련이 필요하며, 대장간 조합이 기술 유출을 엄격하게 관리하고 있다. 조합의 허가 없이 이 기술을 배우거나 사용하는 것은 도시 법으로 금지되어 있다."} />
    </div>
  );
}
