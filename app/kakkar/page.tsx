...
function OverviewSection() {
  return (
    <div>
      <Prose text={"에린딜 대륙과 마쥬라니카 대륙의 사이 바다 밑에는, 「해저 도시」 카칼라 불리는 도시 국가가 있다. 그 도시에는, 언어를 해독하고 문명을 갖추고, 사하긴이라 불리는 어민이 살고 있다."} />
      <SecTitle title="개요" />
      ...
      <SecTitle title="역사" />
      <Prose text={"카칼는, 마쥬라니카 대륙 북쪽 해안에 세워져 있다. 거주민은 사하긴 뿐이지만, 드물게 교역이나 관광 목적의 인간이 방문한다. 사하긴들의 선조는, 마쥬라니카 대륙의 강이나 늪에 서식하는 어족——「뼈를 가진 자들」이라 한다. 그들은 500년여 전, 길만에게 혼란과 교란을 받아 대해로 빠져나가, 「해의 신」 리알에 구원을 호소했다."} />
      <Prose text={"리알는 가호를 받은 사하긴들의 선조를, 길만으로부터 도망치는 것에 성공하게 해 주었다. 그리하여, 대해의 깊은 곳에 사하긴들은 자신들의 땅을 찾아내고, 해수면 아래 200m 정도의 장소에 도시 카칼를 구축했다."} />
      <SecTitle title="현황" />
      <Prose text={"긴 세월을 걸쳐 사하긴들은 늘어나, 각지에 수많은 해저 도시를 세웠다. 그러나 최초의 도시인 카칼는, 가장 번성한 해저 도시로 알려져 있다. 카칼는 다른 해저 도시들과의 교류를 수행하는 상업지이기도 하다. 동시에, 마쥬라니카 대륙에 있는 길만과의 싸움을 촉진하기 위한 군의 거점이기도 하다."} />
      <Prose text={"특히 육상의 인간들과의 경제적·군사적 연락을 중시하고 있으며, 적극적으로 육상으로부터 손님을 초대하는 등, 다양한 시도가 행해지고 있다. 주요 산업은 심해로 향해 채굴되는 해산물과, 마쥬라니카 해안의 화산 근처에서 채굴되는 다양한 금속 가공이다."} />
    </div>
  );
}
...
function CitySection() {
  const districts = [
    { name: "행정구", desc: "도시 중심부에서, 행정에 관련된 기관이나 건물이 집중하고 있다. 왕의 궁전이나 관리들이 모이는 집회 장소, 사하긴이 신앙하는 「해의 신」 리알를 모시는 신사, 육상으로부터 초대된 이방인들이 모이는 이방인관도 모여 있다." },
  ...
  const facilities = [
    { name: "카칼 궁전", desc: "거리 중앙부에 있는 왕의 거처. 무골의 석재가 몇 겹이나 겹쳐 쌓여, 작은 산처럼 된 건축물로, 거리 일대에서 압도적인 크기를 자랑한다. 관문이나 해조류가 암반에 우거져 있어, 곳곳에 날카로운 바위의 돌출이 건물의 입구가 되어 있다." },
    { name: "에엔그라", desc: "거리 중심부에 있는 신전. 해와 바람의 신 리알를 모시는, 대암석으로 만들어진 에엔그라라 불리는 건물 중에, 예배실이나 기도실·신관실 등이 있다. 도시 시민들이 일상적으로 참배하는 장소인 동시에, 관광지이기도 하다." },
    { name: "해저 거신상", desc: "리알 신을 모델로 만들어진 정교한 대형 조각상. 높이 70m에도 미치는 크기로, 사하긴들의 대부분이 그 크기를 실감하고, 진지하게 정면을 마주하는 것이 청산하게 됐다. 군사구에 세워진 이 상은, 해류를 관측하고 외부를 감시하는 첨탑의 역할도 겸하고 있다. 내부에는 몇 개의 열린 공간이 있어, 그 안에서 근무하는 자들의 집무실·왕의 침실·왕의 접견실 등에 할당되고 있다." },
    { name: "고래 정박소", desc: "바다를 자유로 헤엄칠 수 있는 자들에게는, 거리에는 도시 전체를 에워싼 반구형의 지도를 따라 넓게 구획이 잡혀, 거리에 있는 고래들의 유영 공간으로 사용되고 있다. 거리 중앙에는 연이라 불리는 살아있는 것 같은 잠수 殿堂가 있다. 사하긴은 대형 마쥬라니카구의 입구에서 고래에게 인사를 건네는 풍습이 있어 육상에서 오는 인간들에게는 이 고래들이 정박소로 견인하는 관광선이기도 하다." },
  ];
  return (
    <div>
...
function OrgsSection() {
  const orgs = [
    { name: "카칼 궁정", type: "정부 조직", base: "카칼 궁전", leader: "아프칼루 7세", content: "카칼를 다스리는 행정 기구. 장로들이 서로 상담하고, 최종적인 결론은 아래에서 구의 행정이 이루어진다. 국왕은 후대에 영리하다고 알려지는 현명한 왕으로 불린다. 적극적으로 땅에서 오는 인간의 부담을 경감하려 하여, 육상과의 교류를 이끌고 있다." },
    { name: "서방 신전 카칼 교구", type: "종교 조직", base: "에엔그라", leader: "타라트", content: "카칼에 있는 서방 신전의 거점. 하지만 여기서는 오히려 신전이 건설되어 있다는 쪽으로서 있어, 도시의 외곽에서 종교 시설이라기 보다는, 관청처럼 편안한 통로의 거리가 되고 있다. 주변에는 여행자 숙소들도 있고, 외부에서 도시로 와서 탐험자들에게도 이용되고 있다." },
    { name: "카칼 수군", type: "군사 시설", base: "수군 기지", leader: "문무레우슈", content: "카칼의 군족을 장악하고 절단하는 어민이다. 왕의 종복에 해당하는 무인. 극한의 솜씨는 거리 안에서 높은 평가를 받고 있다. 냉담하고 신중한 성격이지만, 토벌 길만에게 향하는 정열은 비할 데가 없다. 도시의 안전과 방어를 굳히기 위해 활동하고 있다." },
    { name: "이기기의 공방", type: "개인 공방", base: "지하 블록", leader: "이기기", content: "카칼의 지하에 만들어진 공동 속에서, 금속 가공을 하는 공방이다. 이기기와 그 이름을 따른 나마즈 같은 직인 기질로 유명한 집단이 특기를 발휘하고 있다. 그 솜씨는 깊은 바다에서도 그 이름을 빛나게 하는 명인이며, 재료가 있으면 어떠한 것이든 소재를 찾을 때 이기기를 방문하면 좋을 것이다." },
    { name: "남방 해류 동맹", type: "상인 조합", base: "상업구", leader: "닌사르", content: "육상과의 통상을 행하는 상인들의 조합. 메나아므마이나 마쥬라니카와의 교역을 중심으로, 상인들이 모여 있다. 해양 도시에서의 교류를 활성화하려 하고 있으며, 거래의 교환이나 이동 수단의 확보를 중시하고 있다. 어업의 동반 모험자들을 보내는데 마음을 쓰고 있으며, 역경을 피하지 않고, 탐험자들을 해저에 안내하는 경우도 있다." },
  ];
  return (
    <div>
      <SecTitle title="카칼의 조직" />
  ...
  const people = [
    {
      ...
      note: "카칼의 종주가 되는 국왕. 타에 비해 눈에 띄는 날카로운 이빨을 가진 어민이다. 정치적으로는 화목을 꾀하는 자세로, 장로들의 의견을 잘 듣는 현명한 왕으로 불린다. 적극적으로 땅에서 오는 인간의 방문을 장려하여, 접견에 다가와 인간의 부담을 줄이고자 노력한다.",
    },
    {
      name: "타라트",
      nameJp: "タラット",
    ...
    },
    {
      ...
      note: "카칼의 군족을 이끄는 어민이다. 왕의 종복에 해당하는 무인이다. 극한의 솜씨는 거리 안에서 높은 평가를 받고 있다. 냉담하고 신중한 성격이지만, 토벌 길만에게 향하는 열정은 비할 데가 없다. 여러 구의 안전과 방어를 굳히기 위해, 도시의 안팎에 걸쳐 불순분자의 침투를 막는 것에도 힘쓰고 있다.",
    },
    {
      name: "이기기",
      nameJp: "イギギ",
      ...
      note: "카칼의 지하 블록에서 철을 두드리기를 멈추지 않는 노어민이다. 나마즈 같은 직인 기질로 유명한 집단 중에서도 특기를 발휘하여 솜씨는 깊은 바다에서도 그 이름을 빛나게 하는 명인이다. 재료가 있으면 어떠한 것이든 소재를 찾을 때, 무기를 비롯해 소재를 찾기 위해 이기기를 방문하면 좋을 것이라 한다.",
    },
    {
      name: "닌사르",
      nameJp: "ニンサル",
      ...
      note: "카칼의 상인 조합을 이끄는 닌사르 여인. 육상과의 인간 교류를 활성화하려 하고 있어, 탐험의 동반자를 중시하고 있다. 적극적인 동반자들을 보내는데 마음을 쓰고 있으며, 탐험자들을 해저에 안내하는 경우가 있다. 자매들이 姉妹들의 장사를 맡고 있는 다재다능한 여인이다.",
    },
  ];
  return (
    <div>
      <Prose text={"카칼를 거점으로 활동하는 주요 인물들."} />
    ...
    <div style={{ display: "flex", height: "100vh", fontFamily: "'Noto Sans KR', sans-serif", background: "#F7F4EE", color: "#2a2a2a" }}>
      ...
      {(!mob || showNav) && (
        <nav style={{ width: mob ? "100vw" : 220, flexShrink: 0, background: SIDEBAR_BG, display: "flex", flexDirection: "column", padding: "24px 0", overflowY: "auto", position: mob ? "fixed" : "relative", top: 0, left: 0, height: "100vh", zIndex: 999 }}>
          <a href="/" style={{ display: "block", padding: "0 20px 20px", textDecoration: "none" }}>
            ...
            <div style={{ fontSize: "15px", fontWeight: 700, color: "#fff", fontFamily: "'Noto Serif KR', serif" }}>카칼</div>
      ...
      <main ref={mainRef} style={{ flex: 1, overflowY: "auto", padding: mob ? "60px 16px 40px" : "40px 48px", maxWidth: 860 }}>
        <div style={{ marginBottom: 28 }}>
          ...
          <h1 style={{ fontFamily: "'Noto Serif KR', serif", fontSize: mob ? "22px" : "26px", fontWeight: 700, color: "#1a1a1a", margin: 0 }}>카칼</h1>
          <div style={{ fontSize: "12px", color: "#aaa", marginTop: 4 }}>カッカル — 에린딜·마쥬라니카 사이 해저 도시</div>
