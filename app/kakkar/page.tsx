...
function OverviewSection() {
  return (
    <div>
      <Prose text={"에린딜 대륙과 마쥬라니카 대륙의 사이 바다 밑에는, 「해저 도시」 캇카르라 불리는 도시 국가가 있다. 그 도시에는, 언어를 해독하고 문명을 갖추고, 사하긴이라 불리는 어민이 살고 있다."} />
      <SecTitle title="개요" />
      ...
      <SecTitle title="역사" />
      <Prose text={"캇카르는, 마쥬라니카 대륙 북쪽 해안에 세워져 있다. 거주민은 사하긴 뿐이지만, 드물게 교역이나 관광 목적의 인간이 방문한다. 사하긴들의 선조는, 마쥬라니카 대륙의 강이나 늪에 서식하는 어족——「뼈를 가진 자들」이라 한다. 그들은 500년여 전, 길만에게 혼란과 교란을 받아 대해로 빠져나가, 「해의 신」 리아르에 구원을 호소했다."} />
      ...
      <SecTitle title="현황" />
      <Prose text={"긴 세월을 걸쳐 사하긴들은 늘어나, 각지에 수많은 해저 도시를 세웠다. 그러나 최초의 도시인 캇카르는, 가장 번성한 해저 도시로 알려져 있다. 캇카르는 다른 해저 도시들과의 교류를 수행하는 상업지이기도 하다. 동시에, 마쥬라니카 대륙에 있는 길만과의 싸움을 촉진하기 위한 군의 거점이기도 하다."} />
