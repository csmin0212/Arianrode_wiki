...
function HistorySection() {
  const events = [
    { year: "성력 719년",  content: "초대 황제 바펠이 핀지아스 섬을 통일하여 반즈탄 제국을 건국. \"바람의 시대\"의 신성왕 알트리우스의 혈통임을 선포한다." },
    { year: "성력 799년",  content: "반즈탄—히유린 일족, 마물 아스트로테에 의해 침략을 당한다. 제국 내부에 큰 혼란이 일어났지만 격퇴에 성공한다." },
    { year: "성력 949년",  content: '"유적의 거리" 두르가르, 반즈탄 제국에 복종하다. 제국의 대륙 진출이 본격적으로 시작된다.' },
    { year: "성력 999년",  content: "반즈탄 제국, 신성 반즈탄 제국으로 개칭. 아르케라브 신앙을 국교로 확립하고 황제의 신성 권위를 선포. 동방으로의 침공을 시작한다." },
    ...
    { year: "성력 1009년", content: "파리스 동맹 그랑펠덴 왕국에 마족 대침공이 발생. 동맹의 전력이 소진된 틈을 노려 제국이 재개전을 준비한다는 정보가 에린디르 전역에 긴장을 일으키고 있다." },
  ];
  return (
    <div>
      <Prose text={"반즈탄 제국은 에린디르 서방의 서쪽 바다, 핀지아스 섬을 근거지로 하여 성력 719년에 성립된 섬나라 제국이다. \"바람의 시대\"의 신성왕 알트리우스의 혈통을 이었다는 황가의 주장을 토대로, 건국 이래 에린디르 대륙 동방으로의 진출을 목표로 세력 확장을 거듭해 왔다."} />
...
function GeographySection() {
  return (
    <div>
      ...
      <Prose text={"신성 반즈탄 제국의 본거지인 핀지아스 섬은 에린디르 대륙에서 서쪽 바다를 건넌 곳에 위치하는 거대한 섬이다. 섬이라는 지형 덕분에 제국은 해군력을 크게 발전시켜, 에린디르 서방의 서쪽 해역 제해권을 장악하고 있다.\n\n기후는 해양성으로 비교적 온화하고, 섬 내부에는 농경지와 목축지가 펼쳐져 있어 식량 자급이 가능하다. 수도 반즈탄은 섬 내부의 반즈 산 중턱에 자리하고 있어 \"천공의 거리\"라는 별명으로 불린다."} />
      <SecTitle title="반즈 산맥과 광물 자원" />
      <Prose text={"핀지아스 섬 내부를 관통하는 반즈 산맥은 에린디르 서방에서도 희귀한 특수 금속의 보고(寶庫)이다. 미스릴과 오리하르콘을 비롯한 고급 금속이 채굴되며, 이것이 제국의 경제적 기반이자 연금술 연구의 핵심 자원이 되고 있다.\n\n산맥의 깊은 곳은 아직 탐사되지 않은 미지의 구역이 남아 있으며, 고대의 금기가 잠들어 있다는 전설도 전해진다."} />
      <SecTitle title="대륙 영토" />
      <Prose text={"핀지아스 섬 외에 제국은 에린디르 대륙에도 영토를 보유하고 있다. 동쪽으로는 \"죽은 자의 늪지\"까지, 북쪽으로는 라셀 강까지가 제국의 세력권으로 여겨진다.\n\n이 대륙 영토에서는 농업과 광업이 이루어지며, 파리스 동맹과의 경계를 이루는 라셀 강 유역은 상시 군사적 긴장이 높은 지역이다."} />
      <SecTitle title="산업과 교역" />
      <Prose text={"미스릴, 오리하르콘 등의 희귀 금속과 이를 원재료로 한 연금술 제품이 주요 수출품이다. 또한 섬 주변 바다에서는 수산물이 풍부하게 잡혀 어업도 중요 산업 중 하나다. 반면 곡물과 식료품은 수입에 의존하는 부분이 있다.\n\n수출품으로는 모직물, 석재, 목재, 귀금속, 무구 등이 있으며, 해상 무역로를 통해 에린디르 각지로 유통된다."} />
    </div>
  );
}
...
function PoliticsSection() {
  return (
    <div>
      ...
      <Prose text={"신성 반즈탄 제국은 황제가 신의 대리인이라는 아르케라브 신앙에 기반한 신성 황제제를 채택하고 있다. 현 황제 제단은 즉위 이전에 위계 계승 후보들이 잇따라 몰락한 끝에 황제 자리에 오른 32세의 젊은 황제다.\n\n제단 황제의 즉위와 함께 이전 체제를 지지했던 구세력의 귀족 상인들이 일소됐고, 연금술사들을 중심으로 한 새로운 지배층이 형성됐다. 제단은 연금술에 한정하지 않고 모든 분야에서 뛰어난 인재를 구하고 있으며, 이는 제국의 국력 강화에도 크게 기여하고 있다."} />
      <SecTitle title="아르케라브 신앙" />
      <Prose text={"제국의 국교인 아르케라브 신앙은 황제의 신성 권위와 불가분하게 결합되어 있다. 황제의 명령은 신의 뜻으로 해석되며, 이 신앙적 권위가 제국 지배의 정통성을 뒷받침한다.\n\n반즈탄 신전은 제국 최대의 신전으로 제국 수도에 위치하며, 신관장 체제가 황제의 의향에 따라 운영된다. 신전 직속 성기사단도 독자적인 전투 능력을 갖추고 있다."} />
      <SecTitle title="군사 — 제국 기사단과 연금 기병" />
      <Prose text={"신성 반즈탄 제국은 에린디르 서방에서도 손꼽히는 군사 강국이다. 제국 기사단이 주전력이며, 귀족 자제만으로 구성되어 사기, 훈련도, 황제에 대한 충성심 모두 최고 수준을 자랑한다.\n\n연금술을 활용한 강화 무장과 연금 전마(戰馬)를 갖춘 연금 기병 부대가 특히 강력하다. 역사상 이 부대에 정면 대결로 이긴 군대는 없다고 전해진다."} />
      <SecTitle title="군사 — 천공 병단 (두앙 천익족)" />
      <Prose text={"제국의 또 다른 핵심 전력이 \"천공 병단\"이다. 핀지아스 섬의 반즈 산맥에 서식하는 두앙 천익족(天翼族)으로 구성된 항공 부대로, 하늘에서의 정찰과 공중 타격을 담당한다. 에린디르 서방에서 이 규모의 항공 전력을 보유한 국가는 제국 외에 없어, 다른 국가들에게 큰 위협이 된다.\n\n천공 병단장 \"하늘의 눈\" 아로이스는 제단 황제와 오래전부터 개인적인 인연이 있는 인물로, 강한 무력으로 알려진 두앙 천익족의 지도자이다."} />
...
function CitiesSection() {
  ...
  return (
    <div>
      <Prose text={"신성 반즈탄 제국은 핀지아스 섬을 중심으로 여러 도시를 보유하고 있다. 그 중에서도 제국 수도 반즈탄과 해항 도시 두르가라는 특히 중요한 위치를 차지한다."} />
...
function EventsSection() {
  const events = [
    {
      title: "신구 탐색",
      content: "제국은 에린디르 각지에 흩어진 \"신구(神具)\"라 불리는 신성 유물들의 행방을 쫓고 있다. 이 탐색은 황제 직속 기관인 \"클란의 광견\"과 \"성도\" 디아스론드의 비밀 결사가 담당하며, 에린디르 전역에 요원이 파견되어 있다. 신구를 통해 신성한 힘을 손에 넣고 에린디르 통일을 이루는 것이 황제 제단의 궁극적 목표라는 소문이 끊이지 않는다.",
    },
    {
    ...
    {
      title: "초대 반즈탄 황제 바펠",
      content: "반즈탄 제국 건국황제 바펠은 \"바람의 시대\"의 신성왕 알트리우스의 혈통을 이었다는 전설을 가지고 있다. 성력 719년 핀지아스 섬을 통일하여 제국을 세운 바펠은, 역대 황제들이 정통성을 주장할 때 반드시 언급되는 이상적 군주상으로 추앙받는다. 신성 황제검 \"크라우·소라스\"도 바펠이 알트리우스로부터 전승받았다는 전설이 있다.",
    },
    {
      title: "반즈 산맥의 수수께끼",
    ...
    },
    {
      ...
      content: "황제 직속 비밀 조직 \"클란의 광견\" 중에서도 가장 수수께끼가 많은 부서가 \"정보부 제13반\"이다. 표면상 해산된 것으로 알려져 있지만, 실제로는 나이가 200세를 넘는다고 추정되는 엘다나안 여성 재뉴어리의 지휘 아래 활동이 지속되고 있다는 소문이 있다. 에린디르 전역에 구축된 정보망을 통해 각국의 동향을 파악하며, 제13반이 접촉해 왔다는 것은 황제가 직접 개입했다는 의미이다.",
    },
  ];
  return (
    <div>
      <Prose text={"신성 반즈탄 제국에 얽힌 전설, 비밀, 현재 진행 중인 사건들을 소개한다."} />
...
function RelationsSection() {
  const relations = [
    { name: "에를랑 왕국",    content: "에를랑 왕국과는 동방 진출을 둘러싸고 전통적으로 긴장 관계에 있다. 에를랑 왕국이 에린디르 서방의 최고(最古) 세력인 만큼, 제국의 동방 진출을 저지하는 가장 큰 장벽이 되고 있다. 양국 사이에는 \"죽은 자의 늪지\" 등 완충 지대가 존재하여 직접 충돌을 피해 왔으나, 제국이 다시 전쟁 준비를 갖추고 있다는 소문이 에루란 측의 경계를 높이고 있다." },
