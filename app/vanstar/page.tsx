...
function HistorySection() {
  const events = [
    { year: "성력 719년", content: "번스터 제국 건국. 피지아스 섬을 거점으로 세력을 확대하기 시작한다." },
    { year: "성력 799년", content: "번스터—히유린 일족, 마물 아스트로테에 의해 침략을 당한다." },
    { year: "성력 949년", content: '"유적의 거리" 두르가르, 번스터 제국에 복종.' },
    { year: "성력 999년", content: '번스터 제국, 신성 번스터 제국으로 개칭. 동방으로의 침공 시작.' },
  ...
  return (
    <div>
      <Prose text={"번스터 제국은 에린디르 서방의 서쪽 바다에 있는 피지아스 섬을 근거지로 하여 성립된 섬나라 제국이다. 건국 이래 에린디르 대륙 동방으로의 진출을 목표로 세력 확장을 거듭해 왔다."} />
...
function GeographySection() {
  return (
    <div>
      ...
      <Prose text={"신성 번스터 제국의 본거지인 피지아스 섬은 에린디르 대륙에서 서쪽 바다를 건넌 곳에 위치하는 큰 섬이다. 섬이라는 지형적 특성 덕분에 제국은 해군력을 발전시켜, 서방 해역의 제해권을 장악하고 있다.\n\n기후는 해양성으로 비교적 온화하며, 서쪽에서 부는 바람으로 인해 풍부한 수자원을 갖추고 있다. 섬 내부에는 농경지와 목축지가 넓게 펼쳐져 있어 자급자족이 가능하다."} />
...
function PoliticsSection() {
  return (
    <div>
      ...
      <Prose text={"신성 번스터 제국은 황제가 정점에 서는 제정 국가이다. 현 황제 제단이 통치하고 있으며, 신성 제국의 이름이 나타내듯 종교와 정치가 강하게 결합된 체제를 갖추고 있다.\n\n황제의 권위는 신에 의해 수여된 것이라는 이념이 지배적이며, 이를 토대로 한 강력한 중앙집권 체제를 형성하고 있다."} />
      <SecTitle title="군사" />
      <Prose text={"신성 번스터 제국은 에린디르 서방에서도 손꼽히는 군사 강국이다. 해군을 비롯한 강대한 군사력을 보유하고 있으며, 동방 진출을 위한 원정 능력을 갖추고 있다.\n\n육군도 강력하며, 과거 동방 침공 시에는 파리스 동맹국들을 크게 위협했다. 현재는 재개전을 준비하고 있다는 정보가 있어, 파리스 동맹을 비롯한 주변국들이 경계를 강화하고 있다."} />
    </div>
  );
}
...
function RelationsSection() {
  const relations = [
    { name: "에를랑 왕국",   content: "에를랑 왕국과는 동방 진출을 둘러싸고 전통적으로 긴장 관계에 있다. 에를랑 왕국이 에린디르 서방의 중심 세력인 만큼, 제국의 동방 진출을 저지하는 가장 큰 장벽이 되고 있다." },
