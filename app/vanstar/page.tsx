...
function HistorySection() {
  const events = [
    ...
    { year: "성력 799년",  content: "반즈탄—휴린 일족, 마물 아스트로테에 의해 침략을 당한다. 제국 내부에 큰 혼란이 일어났지만 격퇴에 성공한다." },
  ...
  return (
    <div>
      <Prose text={"반즈탄 제국은 에린딜 서방의 서쪽 바다, 핀지아스 섬을 근거지로 하여 성력 719년에 성립된 섬나라 제국이다. \"바람의 시대\"의 신성왕 알트리우스의 혈통을 이었다는 황가의 주장을 토대로, 건국 이래 에린딜 대륙 동방으로의 진출을 목표로 세력 확장을 거듭해 왔다."} />
...
function GeographySection() {
  return (
    <div>
      ...
      <Prose text={"신성 반즈탄 제국의 본거지인 핀지아스 섬은 에린딜 대륙에서 서쪽 바다를 건넌 곳에 위치하는 거대한 섬이다. 섬이라는 지형 덕분에 제국은 해군력을 크게 발전시켜, 에린딜 서방의 서쪽 해역 제해권을 장악하고 있다.\n\n기후는 해양성으로 비교적 온화하고, 섬 내부에는 농경지와 목축지가 펼쳐져 있어 식량 자급이 가능하다. 수도 반즈탄은 섬 내부의 반즈 산 중턱에 자리하고 있어 \"천공의 거리\"라는 별명으로 불린다."} />
...
function PoliticsSection() {
  return (
    <div>
      ...
      <Prose text={"신성 반즈탄 제국은 에린딜 서방에서도 손꼽히는 군사 강국이다. 제국 기사단이 주전력이며, 귀족 자제만으로 구성되어 사기, 훈련도, 황제에 대한 충성심 모두 최고 수준을 자랑한다.\n\n연금술을 활용한 강화 무장과 연금 전마(戰馬)를 갖춘 연금 기병 부대가 특히 강력하다. 역사상 이 부대에 정면 대결로 이긴 군대는 없다고 전해진다."} />
    ...
    <div style={{ display: "flex", height: "100vh", fontFamily: "'Noto Sans KR', sans-serif", background: "#F7F4EE", color: "#2a2a2a" }}>
      ...
      <nav style={{
        ...
        <div style={{ padding: "12px 20px", borderTop: "1px solid rgba(255,255,255,0.06)", fontSize: "10px", color: "#504040", lineHeight: 1.6 }}>
          <a href="/erindil-west" style={{ color: "#806070", textDecoration: "none", fontSize: "11px" }}>← 에린딜 서방으로</a>
