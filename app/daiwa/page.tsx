...
function CultureSection() {
  ...
  return (
    <div>
      ...
      <SecTitle title="카운나기 (カンナギ)" />
      <Prose text={"다이와의 신사는 신사라고 불리며, 서방의 신전과는 다른 분위기를 갖고 있다. 그곳에서 행해지는 의례나 의식은 서방의 것과도 이질적이다.\n\n서방에 있어서 아코라이트에 해당하는 일을 카운나기라 불리는 신관이 행한다. 카운나기는 원래 신탁을 다른 이들에게 전하는 역할을 맡고 있었으나, 현재는 그 외에도 특수한 마술의 사용을 능숙히 활용하여, 전장에서도 사람들을 지키기 위한 기원을 올리고, 사람들을 치유하는 술을 행하는 카운나기도 있다."} />
...
function OodoSection() {
  ...
  const orgs = [
    ...
    },
    {
      ...
      base: "아사기리 류 도장",
      leader: "2대 소우에몬 (창설자)",
      content: "전설의 검객 아사기리·소우에몬이 창설했다고 전해지는 검술 도장. 현재 검술의 핵심 도장. 3대부터 타이쿤 가문의 검술 사범 역을 담당하고 있다. 庶民이나 사무라이도 입문할 수 있으며, 문하에는 10년 이상의 경험을 가진 훌륭한 카운나기도 한 명 있다.",
    },
    {
      name: "이로하 組 (いろは組)",
      type: "정부 조직",
