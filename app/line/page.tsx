...
const lineFacilities: Facility[] = [
  ...
  {
    name: "라인 신전 의뢰소",
    content: "거리 북쪽, 대로 근처에 있는 신전. 아케나라브 외 7대 신을 모시고 있으며, 특히 아케나라브를 주신으로 한다. 초대 에를랑 왕국식의 외관을 남기고 있어 품격 있는 분위기가 특징이다. 신전 옆에 세워진 모험자를 위한 의뢰소는 라인 왕국의 모험자 업무를 일괄 관리하는 곳이다. 근처에 많은 유적이 있어 유적 탐사 의뢰가 절반을 차지한다.",
  },
  {
    name: "춤추는 사슴새끼정",
