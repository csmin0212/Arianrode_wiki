...
const lineStats = {
  population: "약 15만 명",
  raceComposition: [
    { race: "히유린",   pct: 38, color: "#2A5F9E" },
    { race: "엘다나안", pct: 20, color: "#1A6B4A" },
...
에루란 왕국의 기록에 의하면, 약 300년 전 중원으로의 행군 때 숲 속에서 고대 군대가 주둔지로 삼은 것이 라인의 기원이라 한다. 이윽고 영주 군주의 대두와 함께 라인 왕국으로서 이 일대는 독립했다. 현재 "유적의 거리"로 알려진 이 거리는, "땅의 시대"의 것으로 생각되는 고대 유적을 기반으로, 오랫동안 라인 왕국의 수도로서 번영해 왔다.
...
const lineFacilities: Facility[] = [
  ...
  {
    name: "라인 신전 의뢰소",
    content: "거리 북쪽, 대로 근처에 있는 신전. 아케나라브 외 7대 신을 모시고 있으며, 특히 아케나라브를 주신으로 한다. 초대 에루란 왕국식의 외관을 남기고 있어 품격 있는 분위기가 특징이다. 신전 옆에 세워진 모험자를 위한 의뢰소는 라인 왕국의 모험자 업무를 일괄 관리하는 곳이다. 근처에 많은 유적이 있어 유적 탐사 의뢰가 절반을 차지한다.",
  },
  {
    name: "춤추는 사슴새끼정",
...
const lineCharacters: Character[] = [
  ...
  },
  {
    ...
    race: "하프 (엘다나안)", gender: "남", age: "134",
    hairColor: "붉은", eyeColor: "파란", skinColor: "흰",
    title: "라인 신전 신관장",
    content: "라인 신전의 신관장. 엘다나안과의 혼혈로 100세를 넘는 오래 사는 현자이다. 오랜 생활 경험에서 얻은 고요하고 침착한 인품으로, 항상 적절히 행동한다. 국왕 에레원드와 함께 여러 위험한 모험 사건을 겪어온 동료로, 국왕의 두터운 신뢰를 받고 있다.",
  },
  {
    name: "ヴィアンナ",
    nameKo: "비안나",
    quote: "중요한 것은 지식과 응용이야",
    race: "엘다나안", gender: "여", age: "불명",
