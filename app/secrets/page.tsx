  ...
  return (
    <section>
      ...
      <div style={{ background: "#0E0A06", border: `1px solid ${ACCENT}`, borderRadius: 8, padding: 14, marginBottom: 16 }}>
        ...
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
          덧붙여 「가르파」들은 전원 여성이고, 외모는 젊은이도 있고 노인도 있고 청년도 있다. 모습이 「가르파」다운 외모를 하고 있는 것뿐이다. 지금까지 모험가들이 에린디일이나 아르디온의 각지에서 「가르파」와 만난 것도 이러한 사정에서다.
        </p>
      </div>
      ...
      <Prose text="또한 이 내용 중에는 당신이 「AR2E」를 GMとして 진행하고 있다면 별도로, 이 선에서 쓰여진 내용을 바탕으로 시나리오를 작성할 수도 있다." />
    </section>
  )
}
...
function InvadersSection() {
  return (
    <section>
      ...
      <Prose text="邪神과 마족은 「精霊의 廃清」에 의해 에린에서 마계로 추방되었다. 에린은 지금 「風の廃清」를 완수하고자 하고 있으며, 에린은 「風の廃清」의 세례를 마쳐 이제 완전히 다른 세계와 이어지지 않게 되었다." />
      <Prose text="하지만 완전히 다른 세계와의 연결이 끊어진 것은 아니다. 邪神의 힘을 가진 것들이 에린에 오면 불가능한 것이 되지 않는다. 그리고 다른 세계의 인간에 가까운 魔族도 있어, 그들 중에는 신들을 찾아 에린에 오려는 자들이 있다." />
      ...
      <div style={{ background: "#0C0808", border: "1px solid #8A3A18", borderRadius: 8, padding: 14, marginBottom: 16 }}>
        ...
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
          邪神이라 불리는 것들은 「古の民」 エルダに 召喚された 다른 세계의 신이다. 에린의 신이 아니다. 그리고 에린에 来訪해 오는 魔族中에는, 그 神들을 찾아 에린의 각지를 헤매거나, 신들을 에린에서 마계로 해방시키려 하는 것들도 있다.
        </p>
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
          이렇게 볼 때, 에린에 来訪해 오는 래구저들은, 그들 자신의 눈으로 보면 신들을 찾아 에린에 온 것이고, 신들과 함께 에린에서 탈출하려 한 것이다. 그리고 동료 マ族을 마계에서 해방시키려 하고 있다.
        </p>
      </div>

      <SecTitle title="「古の民」 에르다" />
      <Prose text="「古の民」 에르다는 에린의 신들이 아닌, 다른 세계의 邪神을 에린에 불러들인 古의 종족이다. 그 이유는 불명이지만, 에르다 자신이 エルダによって 원래 세계와는 다른 성질을 부여받아 현재의 邪神화된 存在が 나타났다고 한다." />
      <Prose text="에르다의 계획에는 끊이지 않는 균열이 생긴다. 자신들이 믿는 신이 에린의 신들로 인해 에린의 邪神へと 변질되었다는 것을 알았기 때문이다. 그 결과, 本来의 다른 세계의 인간에게 에르다는 生物로만 변했다." />
      <Prose text="그리고 邪神은 魔族화된 주민들을 에린에 불러 모으기 시작했고, 魔族たちの 来訪者로서 신의 힘을 빌려 에린에 나타나게 되었다. 더하여 物質界에서의 침략자들 — 다시 말해 来寇者들은, 신들에게 도전하여, 실제로 삼각 전투를 벌이고 있다." />

      <SecTitle title="マ族의 목적" />
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
        {[
          { title: "신들을 찾는 자", desc: "에린의 神들에게 눈을 찌르우는 것, 신들을 에린에서 마계로 해방시키는 것. 이것이 그들의 목적이다. 신들로부터 解放 받아 에린의 사람들의 적이 되는 것은 분명하다." },
          { title: "邪神을 해방시키려는 자", desc: "마계에 봉인된 邪神을 해방시키고자 한다. 이를 위해 에린으로 침입해 신환자들에 맞선다." },
          { title: "에린에 공감하는 자", desc: "에린에 来訪한 邪神のしも베이지만, 긴 세월의 이후에 에린에 공감하게 된 自는 에린을 守護しようと 行動する경우도 있다." },
          { title: "단순히 침략하는 자", desc: "에린의 대地에 목적도 사정도 없이, 단순히 인간들과 에린을 적대하는 魔族도 일정수 있다." },
        ].map(c => (
...
function ScadiSection() {
  return (
    <section>
      ...
      <Prose text="에린에는 대소 다양한 명가가 존재한다. 神들의 廃清 — 신들의 힘을 제거하기 위해 어떤 세력의 힘도 꺾어버릴 수 있다는 소문이 있다. 「불멸의 제후」 스카디. 그것이 그 소문의 정체다." />
      ...
      <div style={{ background: "#080C08", border: `1px solid #3A6A1A`, borderRadius: 8, padding: 14, marginBottom: 16 }}>
        ...
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
          전승에 따르면, 「불멸의 제후」 스카디는 일찍이 「風の廃清」에 의해 소멸했다고 여겨지는 「古の民」 에르다의 후예라 한다.
        </p>
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
          「影の国」이라 불리는 곳에 잠복해 있는 그들은, 그곳에서 세계를 감시하고, 때에 간섭한다. 그들의 언어는 에린의 여러 언어를 능숙하게 사용하며, 正체를 숨기는 것이 得意하다. 스카디는 그 어디에 있는지를 에린을 지키기 위한 「鍵」이라 불리는 존재를 찾고 있다고도 한다.
        </p>
      </div>

      <SecTitle title="스카디의 목적과 행동원리" />
      <Prose text="스카디의 목적: 에린디일을 「神들의 廃清」으로부터 지키는 것. 이 때문에 어떤 특정한 세력이나 개인에게 지나치게 힘이 쏠리지 않도록, 「神들의 廃清」을 일으키지 않도록 하는 것." />
      <div style={{ background: "#0A0C08", border: "1px solid #4A6A18", borderRadius: 8, padding: 14, marginBottom: 16 }}>
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
          스카디의 행동 규범에는 선악이나 사상, 정의나 악의 같은 판단 기준은 없다. 오로지 「神들의 廃清」를 일으키는 환경을 만들지 않기 위해 단순히 힘을 쓸 뿐이다.
        </p>
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
      ...
      <Prose text="스카디는 에린의 여러 세력이나 개인과 교섭한다. 인간이든 마족이든 상관없이, 이 방침을 알고 있는 스카디에게 있어서 그들의 활동은 기이하게 보일 것이다. 또한, 스카디는 廃清을 일으키는 「열쇠」라 불리는 존재를 찾고 있다." />
...
function OverlordSection() {
  return (
    <section>
      ...
      <Prose text="성력 500년경 파리스 왕국을 건국해, 에린디일 서방의 중원을 통일한 걸물(傑物) — 「패왕」. 그 영웅이 일으킨 수많은 전설이 많은 사람들의 입에서 전해지고 있다." />
      <Prose text="「패왕」의 정체는 오랫동안 謎에 싸여 있었다. 현재도 그 이름 두 가지만이 전해지고 있다." />
      ...
      <Prose text="「古の民」 에르다의 생존자로서, 역사에 영향을 미치고자 활약하는 조직의 일원이면서도, 인간을 위해 싸우는 존재가 있다. 그 이름은 아론다이트." />
      <div style={{ background: "#0A0A0A", border: "1px solid #5A5A18", borderRadius: 8, padding: 14 }}>
        ...
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
          에르다의 長 — 「神聖王」 아르토리우스의 충실한 기사였다. 그의 부친이 에르다이며, 어머니는 현재의 방새 도시 티르·나·노그(현 방새 도시)의 대지의 妖精이었다고 한다.
        </p>
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
          아론다이트는 아르토리우스의 사후, 몇 번의 廃清을 살아남아 많은 무훈을 쌓아왔다. 그 끝없는 수행의 결과, 그는 신환자에 버금가는 힘을 얻었다. 현재 에르크레스트·카레지의 학생으로서, 또한 에르크레스트·카레지의 역사학 교수 오레스트·모즈레이가 그녀의 제자이기도 하다.
        </p>
      </div>
    </section>
  )
...
function BalmunkSection() {
  const founders = [
    {
      ...
      title: "「검의 왕 (노트룽)」",
      hair: "—", eyes: "—", skin: "—",
      desc: "과거/현재/미래를 나타내는 3×12매의 날개를 가진 마족. 인간에게는 코우모리와 비슷한 날개를 가진 남성 모습으로 접근한다. 강한 자를 굴복시켜 따르게 하는 것을 좋아한다. 세계 구제 계획의 신구 나추라르파를 불러내려 했으나, 그 당시 소멸했다. 帝紀812년 12월, 부활하여 마수군 「황금의 狼」에 의해 「완전한 죽음」을 받았다.",
    },
    {
  ...
  return (
    <section>
      ...
      <Prose text="긴 전쟁이 이어진 아르디온 대륙 동방에서, 인류 총화(帝紀816년)를 계기로 일정의 평화가 찾아왔다. 그 전쟁의 이면에는, バルムンク라 불리는 비밀 결사가 있었다고 한다." />
      ...
      <div style={{ background: "#0C0808", border: "1px solid #8A1A1A", borderRadius: 8, padding: 14, marginBottom: 16 }}>
        ...
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
          발뭉크의 목적: 아르디온 대륙 동방에 混成마족을 상대하는 전쟁 태세를 유지하는 것.
          구성원은 魔族과 魔族에 협력하는 인간들, 그리고 각국의 왕가와 유력자 사이에 침투해 있으며, 국가 세력의 대립과 전쟁을 부추기는 활동을 해왔다.
        </p>
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
          발뭉크를 창설한 「시조의 4인」은 두 명이 邪神 계열의 마족, (혹은 인간), 두 명은 인간이다. 그들의 존재는 알려지기까지 오랜 시간이 걸렸다. 그러나 많은 영웅들이 이들과 싸우려 했지만, 시조의 4인을 쓰러뜨리기 위해서는 긴 전투가 필요하다.
        </p>
      </div>
  ...
  return (
    <section>
      ...
      <div style={{ background: "#080C10", border: "1px solid #1A4A8A", borderRadius: 8, padding: 14, marginBottom: 16 }}>
        ...
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
          에린을, 인류를 「神들의 支配」와 「魔族의 수탈」로부터 해방시키기 위한 계획이다.
      ...
      <Prose text="세계 구제 계획의 스케일은 좀처럼 머릿속에 그리기 어렵다. 단, 来寇者들이 人類를 넘어 이동하는 것은 불가능하지 않다. 또한 이와 같이 「작은 세계」라고도 부를 수 있는 거주 가능한 영역이, 그밖에도 존재하고 있는 것을 상상시킨다." />
      <Prose text="현재, 계획은 아직 진행 중이다. 세계 구제 계획과 함께, 에린의 그 외 지역으로부터 하나의 경계 구역을 잘라내려 한다. 그러나 무엇보다도, 에린의 외부에서 오는 来寇者의 존재를 보여준다. 더하여 이와 같이 생겨난 「작은 세계」라고도 부를 수 있는 거주 가능한 영역이 그밖에도 존재하고 있을 것이다." />

      <SecTitle title="관련 이벤트 연표" />
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        {[
          { year: "帝紀812년 12월", event: "마수군 「황금의 狼」, 베리알에게 「완전한 죽음」을 부여. 베리알 소멸." },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
        {[
          {
            name: "베르프트·바우에스·레이워르드", nameJp: "ベルフト·バウエス·レイウォールド",
