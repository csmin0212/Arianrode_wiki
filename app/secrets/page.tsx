  ...
  return (
    <section>
      ...
      <div style={{ background: "#0C0808", border: "1px solid #8A3A18", borderRadius: 8, padding: 14, marginBottom: 16 }}>
        ...
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
          사신이라 불리는 것들은 「고대 민족」 엘더에 의해 소환된 다른 세계의 신이다. 에린의 신이 아니다. 그리고 에린에 찾아오는 마족 중에는, 그 신들을 찾아 에린의 각지를 헤매거나, 신들을 에린에서 마계로 해방시키려 하는 것들도 있다.
        </p>
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
      ...
      <SecTitle title="「고대 민족」 엘더" />
      <Prose text="「고대 민족」 엘더는 에린의 신들이 아닌, 다른 세계의 사신을 에린에 불러들인 고대의 종족이다. 그 이유는 불명이지만, 엘더 자신이 엘더에 의해 원래 세계와는 다른 성질을 부여받아 현재의 사신화된 존재가 나타났다고 한다." />
      <Prose text="엘더의 계획에는 끊이지 않는 균열이 생긴다. 자신들이 믿는 신이 에린의 신들로 인해 에린의 사신으로 변질되었다는 것을 알았기 때문이다. 그 결과, 본래의 다른 세계의 인간에게 엘더는 생물로만 변했다." />
  ...
  return (
    <section>
      ...
      <div style={{ background: "#080C08", border: `1px solid #3A6A1A`, borderRadius: 8, padding: 14, marginBottom: 16 }}>
        ...
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
          전승에 따르면, 「불멸의 제후」 스카디는 일찍이 「바람의 폐청」에 의해 소멸했다고 여겨지는 「고대 민족」 엘더의 후예라 한다.
        </p>
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
    ...
    <section>
      ...
      <div style={{ background: "#0C0808", border: `1px solid ${ACCENT}`, borderRadius: 8, padding: 14, marginBottom: 16 }}>
        ...
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
          ...
          당시 확대 일도에 있던 에를랑랑 왕국의 독주를 꺾기 위해 스카디로부터 임무를 수행하러 왔다.
        </p>
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
          그녀는 6인의 동료 (「패왕의 유산」이라 불리는 6개의 강력한 마법 도구를 가진 자들)의 협력으로 중원을 통일하여 파리스 왕국을 건국했고, 에를랑랑 왕국에 대항했다.
        </p>
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
          파리스 왕국이라는 강대한 적의 출현으로 인해, 에를랑랑 왕국은 쇠락해 가기 시작했다. 단, 샬릴시아도 예상치 못한 사태가 일어났다. 샬릴시아의 배신으로 인해, 그 자식이 세상을 떠나게 된다. 그리고 자식을 잃은 에를랑랑 왕국은 결국 무너졌다.
        </p>
      </div>

      <SecTitle title="아론다이트와 엘더의 후예" />
      <Prose text="「고대 민족」 엘더의 생존자로서, 역사에 영향을 미치고자 활약하는 조직의 일원이면서도, 인간을 위해 싸우는 존재가 있다. 그 이름은 아론다이트." />
      <div style={{ background: "#0A0A0A", border: "1px solid #5A5A18", borderRadius: 8, padding: 14 }}>
        ...
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
          엘더의 수장 — 「신성왕」 아르토리우스의 충실한 기사였다. 그의 부친이 엘더이며, 어머니는 현재의 방새 도시 티르·나·노그(현 방새 도시)의 대지의 요정이었다고 한다.
        </p>
        <p style={{ color: "#D8CCA8", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
          아론다이트는 아르토리우스의 사후, 몇 번의 폐청을 살아남아 많은 무훈을 쌓아왔다. 그 끝없는 수행의 결과, 그는 신환자에 버금가는 힘을 얻었다. 현재 에르크레스트·칼리지의 학생으로서, 또한 에르크레스트·칼리지의 역사학 교수 오레스트·모즈레이가 그녀의 제자이기도 하다.
        </p>
      </div>
    </section>
  )
